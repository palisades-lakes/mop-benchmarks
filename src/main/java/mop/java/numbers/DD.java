...
//    return parse(str); }
   ...
   * @return the extended precision version of the value
   */
  public static DD valueOf (float x) { return new DD(x); }
...
//  }
   ...
   */
  public double doubleValue () { return hi + lo; }
   ...
   */
  public float floatValue () { return (float) (hi + lo); }

  /** Converts this value to the nearest integer.
   *
   * @return the nearest integer to this value
   */
  public int intValue () { return (int) hi; }
