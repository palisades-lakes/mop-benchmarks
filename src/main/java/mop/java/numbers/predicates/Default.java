...
import static mop.java.numbers.predicates.Expansion.EPSILON;
...
public final class Default implements Predicate {

  //--------------------------------------------------------------------
  // orient2d
  //--------------------------------------------------------------------
  private final double ccwerrboundA =
  ...
  public final double orient2d (final double[] pa,
    ...
    return new Adapt().orient2d(pa, pb, pc, detsum);
  }

  //--------------------------------------------------------------------
  // orient3d
  //--------------------------------------------------------------------
  private final double o3derrboundA =
  ...
  // incircle
  //--------------------------------------------------------------------
  private final double iccerrboundA =
  ...
  public final double incircle (final double[] pa,
    ...
    return new Adapt().incircle(pa, pb, pc, pd, permanent);
  }

  //--------------------------------------------------------------------
  // insphere
  //--------------------------------------------------------------------
  private final double isperrboundA =
  ...
  public final double insphere (final double[] pa,
    ...
    return new Adapt().insphere(pa, pb, pc, pd, pe, permanent);
  }
  //--------------------------------------------------------------------
  // construction
  //--------------------------------------------------------------------
