...
strictfp public final class Pred0 {
...
//  Sometimes this problem can be fixed by defining certain values to be
//  volatile, thus forcing them to be stored to memory and rounded off.
//  This isn't a great solution, though, as it slows the arithmetic down.
//  To try this out, write "#define INEXACT volatile" below.
//  Normally, however, INEXACT should be defined to be nothing.  ("#define
//  INEXACT".)
...
// all floating point calculations to have IEEE 754 semantics.
  ...
  // class methods
  //--------------------------------------------------------------------
  private static final int grow_expansion (final int elen,
                                           final double[] e,
                                           final double b,
                                           final double[] h) {
    double Q;
    ...
    for (eindex = 0; eindex < elen; eindex++) {
      enow = e[eindex];
      Qnew = (double) (Q + enow); bvirt = (double) (Qnew - Q);
  ...
  //--------------------------------------------------------------------
  private static final int grow_expansion_zeroelim (final int elen,
                                                    final double[] e,
                                                    final double b,
                                                    final double[] h) {
    double Q, hh;
  ...
  //--------------------------------------------------------------------
  private static final int expansion_sum (final int elen,
                                          final double[] e,
                                          final int flen,
                                          final double[] f,
                                          final double[] h) {
    ...
    for (hindex = 0; hindex < elen; hindex++) {
      hnow = e[hindex];
      Qnew = (double) (Q + hnow); bvirt = (double) (Qnew - Q);
  ...
  //--------------------------------------------------------------------
  private static final int expansion_sum_zeroelim1 (final int elen,
                                                    final double[] e,
                                                    final int flen,
                                                    final double[] f,
                                                    final double[] h) {
  ...
  //--------------------------------------------------------------------
  private static final int expansion_sum_zeroelim2 (final int elen,
                                                    final double[] e,
                                                    final int flen,
                                                    final double[] f,
                                                    final double[] h) {
  ...
  //--------------------------------------------------------------------
  private static final int fast_expansion_sum (final int elen,
                                               final double[] e,
                                               final int flen,
                                               final double[] f,
                                               final double[] h) {
    ...
    if ((eindex < elen) && (findex < flen)) {
      if ((fnow > enow) == (fnow > -enow)) {
        Qnew = (double) (enow + Q); bvirt = Qnew - enow;
        h[0] = Q - bvirt;
        enow = e[++eindex];
      }
      else {
        Qnew = (double) (fnow + Q); bvirt = Qnew - fnow;
        h[0] = Q - bvirt;
        fnow = f[++findex];
      }
      Q = Qnew;
      ...
      while ((eindex < elen) && (findex < flen)) {
        if ((fnow > enow) == (fnow > -enow)) {
          ...
          Qnew = (double) (Q + fnow); bvirt = (double) (Qnew - Q);
  ...
  //--------------------------------------------------------------------
  private static final int fast_expansion_sum_zeroelim (final int elen,
                                                        final double[] e,
                                                        final int flen,
                                                        final double[] f,
                                                        final double[] h) {
  ...
  //--------------------------------------------------------------------
  private static final int linear_expansion_sum (final int elen,
                                                 final double[] e,
                                                 final int flen,
                                                 final double[] f,
                                                 final double[] h) {
    ...
    for (hindex = 0; hindex < elen + flen - 2; hindex++) {
      if ((eindex < elen) && ((findex >= flen)
        || ((fnow > enow) == (fnow > -enow)))) {
        R = (double) (enow + q); bvirt = R - enow;
        h[hindex] = q - bvirt;
        enow = e[++eindex];
      }
      else {
        R = (double) (fnow + q); bvirt = R - fnow;
        h[hindex] = q - bvirt;
        fnow = f[++findex];
      }
      Qnew = (double) (Q + R); bvirt = (double) (Qnew - Q);
  ...
  //--------------------------------------------------------------------
  private static final int linear_expansion_sum_zeroelim (
    final int elen,
    final double[] e,
    final int flen,
    final double[] f,
  ...
  //--------------------------------------------------------------------
  private static final int scale_expansion (final int elen,
                                            final double[] e,
                                            final double b,
                                            final double[] h) {
    double Q;
    ...
    c = (double) (SPLITTER * b); abig = (double) (c - b);
    bhi = c - abig; blo = b - bhi;
    Q = (double) (e[0] * b); c = (double) (SPLITTER * e[0]);
    abig = (double) (c - e[0]); ahi = c - abig; alo = e[0] - ahi;
    err1 = Q - (ahi * bhi); err2 = err1 - (alo * bhi);
    err3 = err2 - (ahi * blo); h[0] = (alo * blo) - err3;
    hindex = 1;
    for (eindex = 1; eindex < elen; eindex++) {
      enow = e[eindex];
      product1 = (double) (enow * b); c = (double) (SPLITTER * enow);
      abig = (double) (c - enow); ahi = c - abig; alo = enow - ahi;
      err1 = product1 - (ahi * bhi); err2 = err1 - (alo * bhi);
      err3 = err2 - (ahi * blo); product0 = (alo * blo) - err3;
      sum = (double) (Q + product0); bvirt = (double) (sum - Q);
      avirt = sum - bvirt; bround = product0 - bvirt;
      around = Q - avirt; h[hindex] = around + bround;
      hindex++;
      Q = (double) (product1 + sum); bvirt = (double) (Q - product1);
  ...
  //--------------------------------------------------------------------
  private static final int scale_expansion_zeroelim (final int elen,
                                                     final double[] e,
                                                     final double b,
                                                     final double[] h) {
    double Q, sum;
    ...
    for (eindex = 1; eindex < elen; eindex++) {
      ...
      Q = (double) (product1 + sum); bvirt = Q - product1;
      hh = sum - bvirt;
      if (hh != 0) {
        h[hindex++] = hh;
      }
  ...
  //--------------------------------------------------------------------
  private static final int compress (final int elen,
                                     final double[] e,
                                     final double[] h) {
    double Q, q;
    double Qnew;
    ...
    for (eindex = elen - 2; eindex >= 0; eindex--) {
      enow = e[eindex];
      Qnew = (double) (Q + enow); bvirt = Qnew - Q; q = enow - bvirt;
      if (q != 0) {
        h[bottom--] = Qnew;
        Q = q;
      }
    ...
    for (hindex = bottom + 1; hindex < elen; hindex++) {
      hnow = h[hindex];
      Qnew = (double) (hnow + Q); bvirt = Qnew - hnow; q = Q - bvirt;
      if (q != 0) {
        h[top++] = q;
      }
      Q = Qnew;
  ...
  //--------------------------------------------------------------------
  private static final double estimate (final int elen,
                                        final double[] e) {
    double Q;
    int eindex;
  ...
  //--------------------------------------------------------------------
  private static final double orient2dfast (final double[] pa,
                                            final double[] pb,
                                            final double[] pc) {
  ...
  //--------------------------------------------------------------------
  private static final double orient2dexact (final double[] pa,
                                             final double[] pb,
                                             final double[] pc) {
    ...
    axby1 = (double) (pa[0] * pb[1]); c = (double) (SPLITTER * pa[0]);
    abig = (double) (c - pa[0]); ahi = c - abig; alo = pa[0] - ahi;
    c = (double) (SPLITTER * pb[1]); abig = (double) (c - pb[1]);
    bhi = c - abig; blo = pb[1] - bhi; err1 = axby1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    axby0 = (alo * blo) - err3;
    axcy1 = (double) (pa[0] * pc[1]); c = (double) (SPLITTER * pa[0]);
    abig = (double) (c - pa[0]); ahi = c - abig; alo = pa[0] - ahi;
    c = (double) (SPLITTER * pc[1]); abig = (double) (c - pc[1]);
    bhi = c - abig; blo = pc[1] - bhi; err1 = axcy1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    axcy0 = (alo * blo) - err3;
    _i = (double) (axby0 - axcy0); bvirt = (double) (axby0 - _i);
    avirt = _i + bvirt; bround = bvirt - axcy0; around = axby0 - avirt;
    aterms[0] = around + bround; _j = (double) (axby1 + _i);
    bvirt = (double) (_j - axby1); avirt = _j - bvirt;
    bround = _i - bvirt; around = axby1 - avirt;
    _0 = around + bround; _i = (double) (_0 - axcy1);
    bvirt = (double) (_0 - _i); avirt = _i + bvirt;
    bround = bvirt - axcy1; around = _0 - avirt;
    aterms[1] = around + bround; aterms3 = (double) (_j + _i);
    bvirt = (double) (aterms3 - _j); avirt = aterms3 - bvirt;
    bround = _i - bvirt; around = _j - avirt;
    aterms[2] = around + bround;
    aterms[3] = aterms3;

    bxcy1 = (double) (pb[0] * pc[1]); c = (double) (SPLITTER * pb[0]);
    abig = (double) (c - pb[0]); ahi = c - abig; alo = pb[0] - ahi;
    c = (double) (SPLITTER * pc[1]); abig = (double) (c - pc[1]);
    bhi = c - abig; blo = pc[1] - bhi; err1 = bxcy1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    bxcy0 = (alo * blo) - err3;
    bxay1 = (double) (pb[0] * pa[1]); c = (double) (SPLITTER * pb[0]);
    abig = (double) (c - pb[0]); ahi = c - abig; alo = pb[0] - ahi;
    c = (double) (SPLITTER * pa[1]); abig = (double) (c - pa[1]);
    bhi = c - abig; blo = pa[1] - bhi; err1 = bxay1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    bxay0 = (alo * blo) - err3;
    _i = (double) (bxcy0 - bxay0); bvirt = (double) (bxcy0 - _i);
    avirt = _i + bvirt; bround = bvirt - bxay0; around = bxcy0 - avirt;
    bterms[0] = around + bround; _j = (double) (bxcy1 + _i);
    bvirt = (double) (_j - bxcy1); avirt = _j - bvirt;
    bround = _i - bvirt; around = bxcy1 - avirt; _0 = around + bround;
    _i = (double) (_0 - bxay1); bvirt = (double) (_0 - _i);
    avirt = _i + bvirt; bround = bvirt - bxay1; around = _0 - avirt;
    bterms[1] = around + bround; bterms3 = (double) (_j + _i);
    bvirt = (double) (bterms3 - _j); avirt = bterms3 - bvirt;
    bround = _i - bvirt; around = _j - avirt;
    bterms[2] = around + bround;
    bterms[3] = bterms3;

    cxay1 = (double) (pc[0] * pa[1]); c = (double) (SPLITTER * pc[0]);
    abig = (double) (c - pc[0]); ahi = c - abig; alo = pc[0] - ahi;
    c = (double) (SPLITTER * pa[1]); abig = (double) (c - pa[1]);
    bhi = c - abig; blo = pa[1] - bhi; err1 = cxay1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    cxay0 = (alo * blo) - err3;
    cxby1 = (double) (pc[0] * pb[1]); c = (double) (SPLITTER * pc[0]);
    abig = (double) (c - pc[0]); ahi = c - abig; alo = pc[0] - ahi;
    c = (double) (SPLITTER * pb[1]); abig = (double) (c - pb[1]);
    bhi = c - abig; blo = pb[1] - bhi; err1 = cxby1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    cxby0 = (alo * blo) - err3;
    _i = (double) (cxay0 - cxby0); bvirt = (double) (cxay0 - _i);
    avirt = _i + bvirt; bround = bvirt - cxby0; around = cxay0 - avirt;
    cterms[0] = around + bround; _j = (double) (cxay1 + _i);
    bvirt = (double) (_j - cxay1); avirt = _j - bvirt;
    bround = _i - bvirt; around = cxay1 - avirt; _0 = around + bround;
    _i = (double) (_0 - cxby1); bvirt = (double) (_0 - _i);
    avirt = _i + bvirt; bround = bvirt - cxby1; around = _0 - avirt;
    cterms[1] = around + bround; cterms3 = (double) (_j + _i);
    bvirt = (double) (cterms3 - _j); avirt = cterms3 - bvirt;
    bround = _i - bvirt; around = _j - avirt;
  ...
  //--------------------------------------------------------------------
  private static final double orient2dslow (final double[] pa,
                                            final double[] pb,
                                            final double[] pc) {
    ...
    acx = (double) (pa[0] - pc[0]); bvirt = (double) (pa[0] - acx);
    avirt = acx + bvirt; bround = bvirt - pc[0]; around = pa[0] - avirt;
    acxtail = around + bround;
    acy = (double) (pa[1] - pc[1]); bvirt = (double) (pa[1] - acy);
    avirt = acy + bvirt; bround = bvirt - pc[1]; around = pa[1] - avirt;
    acytail = around + bround;
    bcx = (double) (pb[0] - pc[0]); bvirt = (double) (pb[0] - bcx);
    avirt = bcx + bvirt; bround = bvirt - pc[0]; around = pb[0] - avirt;
    bcxtail = around + bround;
    bcy = (double) (pb[1] - pc[1]); bvirt = (double) (pb[1] - bcy);
    avirt = bcy + bvirt; bround = bvirt - pc[1]; around = pb[1] - avirt;
    bcytail = around + bround;

    c = (double) (SPLITTER * acxtail); abig = (double) (c - acxtail);
    a0hi = c - abig; a0lo = acxtail - a0hi;
    c = (double) (SPLITTER * bcytail); abig = (double) (c - bcytail);
    bhi = c - abig; blo = bcytail - bhi;
    _i = (double) (acxtail * bcytail); err1 = _i - (a0hi * bhi);
    err2 = err1 - (a0lo * bhi); err3 = err2 - (a0hi * blo);
    axby[0] = (a0lo * blo) - err3; c = (double) (SPLITTER * acx);
    abig = (double) (c - acx); a1hi = c - abig; a1lo = acx - a1hi;
    _j = (double) (acx * bcytail); err1 = _j - (a1hi * bhi);
    err2 = err1 - (a1lo * bhi); err3 = err2 - (a1hi * blo);
    _0 = (a1lo * blo) - err3; _k = (double) (_i + _0);
    bvirt = (double) (_k - _i); avirt = _k - bvirt; bround = _0 - bvirt;
    around = _i - avirt; _1 = around + bround; _l = (double) (_j + _k);
    bvirt = _l - _j; _2 = _k - bvirt; c = (double) (SPLITTER * bcy);
    abig = (double) (c - bcy); bhi = c - abig; blo = bcy - bhi;
    _i = (double) (acxtail * bcy); err1 = _i - (a0hi * bhi);
    err2 = err1 - (a0lo * bhi); err3 = err2 - (a0hi * blo);
    _0 = (a0lo * blo) - err3; _k = (double) (_1 + _0);
    bvirt = (double) (_k - _1); avirt = _k - bvirt; bround = _0 - bvirt;
    around = _1 - avirt; axby[1] = around + bround;
    _j = (double) (_2 + _k); bvirt = (double) (_j - _2);
    avirt = _j - bvirt; bround = _k - bvirt; around = _2 - avirt;
    _1 = around + bround; _m = (double) (_l + _j);
    bvirt = (double) (_m - _l); avirt = _m - bvirt; bround = _j - bvirt;
    around = _l - avirt; _2 = around + bround;
    _j = (double) (acx * bcy); err1 = _j - (a1hi * bhi);
    err2 = err1 - (a1lo * bhi); err3 = err2 - (a1hi * blo);
    _0 = (a1lo * blo) - err3; _n = (double) (_i + _0);
    bvirt = (double) (_n - _i); avirt = _n - bvirt; bround = _0 - bvirt;
    around = _i - avirt; _0 = around + bround; _i = (double) (_1 + _0);
    bvirt = (double) (_i - _1); avirt = _i - bvirt; bround = _0 - bvirt;
    around = _1 - avirt; axby[2] = around + bround;
    _k = (double) (_2 + _i); bvirt = (double) (_k - _2);
    avirt = _k - bvirt; bround = _i - bvirt; around = _2 - avirt;
    _1 = around + bround; _l = (double) (_m + _k);
    bvirt = (double) (_l - _m); avirt = _l - bvirt; bround = _k - bvirt;
    around = _m - avirt; _2 = around + bround; _k = (double) (_j + _n);
    bvirt = (double) (_k - _j); avirt = _k - bvirt; bround = _n - bvirt;
    around = _j - avirt; _0 = around + bround; _j = (double) (_1 + _0);
    bvirt = (double) (_j - _1); avirt = _j - bvirt; bround = _0 - bvirt;
    around = _1 - avirt; axby[3] = around + bround;
    _i = (double) (_2 + _j); bvirt = (double) (_i - _2);
    avirt = _i - bvirt; bround = _j - bvirt; around = _2 - avirt;
    _1 = around + bround; _m = (double) (_l + _i);
    bvirt = (double) (_m - _l); avirt = _m - bvirt; bround = _i - bvirt;
    around = _l - avirt; _2 = around + bround; _i = (double) (_1 + _k);
    bvirt = (double) (_i - _1); avirt = _i - bvirt; bround = _k - bvirt;
    around = _1 - avirt; axby[4] = around + bround;
    _k = (double) (_2 + _i); bvirt = (double) (_k - _2);
    avirt = _k - bvirt; bround = _i - bvirt; around = _2 - avirt;
    axby[5] = around + bround; axby7 = (double) (_m + _k);
    bvirt = (double) (axby7 - _m); avirt = axby7 - bvirt;
    bround = _k - bvirt; around = _m - avirt; axby[6] = around + bround;
    axby[7] = axby7;
    negate = -acy;
    negatetail = -acytail;
    c = (double) (SPLITTER * bcxtail); abig = (double) (c - bcxtail);
    a0hi = c - abig; a0lo = bcxtail - a0hi;
    c = (double) (SPLITTER * negatetail);
    abig = (double) (c - negatetail); bhi = c - abig;
    blo = negatetail - bhi; _i = (double) (bcxtail * negatetail);
    err1 = _i - (a0hi * bhi); err2 = err1 - (a0lo * bhi);
    err3 = err2 - (a0hi * blo); bxay[0] = (a0lo * blo) - err3;
    c = (double) (SPLITTER * bcx); abig = (double) (c - bcx);
    a1hi = c - abig; a1lo = bcx - a1hi;
    _j = (double) (bcx * negatetail); err1 = _j - (a1hi * bhi);
    err2 = err1 - (a1lo * bhi); err3 = err2 - (a1hi * blo);
    _0 = (a1lo * blo) - err3; _k = (double) (_i + _0);
    bvirt = (double) (_k - _i); avirt = _k - bvirt; bround = _0 - bvirt;
    around = _i - avirt; _1 = around + bround; _l = (double) (_j + _k);
    bvirt = _l - _j; _2 = _k - bvirt; c = (double) (SPLITTER * negate);
    abig = (double) (c - negate); bhi = c - abig; blo = negate - bhi;
    _i = (double) (bcxtail * negate); err1 = _i - (a0hi * bhi);
    err2 = err1 - (a0lo * bhi); err3 = err2 - (a0hi * blo);
    _0 = (a0lo * blo) - err3; _k = (double) (_1 + _0);
    bvirt = (double) (_k - _1); avirt = _k - bvirt; bround = _0 - bvirt;
    ...
    bvirt = (double) (_m - _l); avirt = _m - bvirt; bround = _j - bvirt;
    around = _l - avirt; _2 = around + bround;
    _j = (double) (bcx * negate); err1 = _j - (a1hi * bhi);
    err2 = err1 - (a1lo * bhi); err3 = err2 - (a1hi * blo);
    _0 = (a1lo * blo) - err3; _n = (double) (_i + _0);
    bvirt = (double) (_n - _i); avirt = _n - bvirt; bround = _0 - bvirt;
    around = _i - avirt; _0 = around + bround; _i = (double) (_1 + _0);
    ...
    _k = (double) (_2 + _i); bvirt = (double) (_k - _2);
    avirt = _k - bvirt; bround = _i - bvirt; around = _2 - avirt;
    bxay[5] = around + bround; bxay7 = (double) (_m + _k);
    bvirt = (double) (bxay7 - _m); avirt = bxay7 - bvirt;
  ...
  private static final double orient2dadapt (final double[] pa,
    ...
    detleft = (double) (acx * bcy); c = (double) (SPLITTER * acx);
    abig = (double) (c - acx); ahi = c - abig; alo = acx - ahi;
    c = (double) (SPLITTER * bcy); abig = (double) (c - bcy);
    bhi = c - abig; blo = bcy - bhi; err1 = detleft - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    detlefttail = (alo * blo) - err3;
    detright = (double) (acy * bcx); c = (double) (SPLITTER * acy);
    abig = (double) (c - acy); ahi = c - abig; alo = acy - ahi;
    c = (double) (SPLITTER * bcx); abig = (double) (c - bcx);
    ...
    bvirt = (double) (detlefttail - _i); avirt = _i + bvirt;
    bround = bvirt - detrighttail; around = detlefttail - avirt;
    B[0] = around + bround; _j = (double) (detleft + _i);
    bvirt = (double) (_j - detleft); avirt = _j - bvirt;
    bround = _i - bvirt; around = detleft - avirt; _0 = around + bround;
    _i = (double) (_0 - detright); bvirt = (double) (_0 - _i);
    avirt = _i + bvirt; bround = bvirt - detright; around = _0 - avirt;
    B[1] = around + bround; B3 = (double) (_j + _i);
    bvirt = (double) (B3 - _j); avirt = B3 - bvirt; bround = _i - bvirt;
    ...
    bvirt = (double) (pa[0] - acx); avirt = acx + bvirt;
    bround = bvirt - pc[0]; around = pa[0] - avirt;
    acxtail = around + bround;
    bvirt = (double) (pb[0] - bcx); avirt = bcx + bvirt;
    bround = bvirt - pc[0]; around = pb[0] - avirt;
    bcxtail = around + bround;
    bvirt = (double) (pa[1] - acy); avirt = acy + bvirt;
    bround = bvirt - pc[1]; around = pa[1] - avirt;
    acytail = around + bround;
    bvirt = (double) (pb[1] - bcy); avirt = bcy + bvirt;
    ...
    s1 = (double) (acxtail * bcy); c = (double) (SPLITTER * acxtail);
    abig = (double) (c - acxtail); ahi = c - abig; alo = acxtail - ahi;
    c = (double) (SPLITTER * bcy); abig = (double) (c - bcy);
    bhi = c - abig; blo = bcy - bhi; err1 = s1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    s0 = (alo * blo) - err3;
    t1 = (double) (acytail * bcx); c = (double) (SPLITTER * acytail);
    abig = (double) (c - acytail); ahi = c - abig; alo = acytail - ahi;
    c = (double) (SPLITTER * bcx); abig = (double) (c - bcx);
    bhi = c - abig; blo = bcx - bhi; err1 = t1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    t0 = (alo * blo) - err3;
    _i = (double) (s0 - t0); bvirt = (double) (s0 - _i);
    avirt = _i + bvirt; bround = bvirt - t0; around = s0 - avirt;
    u[0] = around + bround; _j = (double) (s1 + _i);
    bvirt = (double) (_j - s1); avirt = _j - bvirt; bround = _i - bvirt;
    around = s1 - avirt; _0 = around + bround; _i = (double) (_0 - t1);
    bvirt = (double) (_0 - _i); avirt = _i + bvirt; bround = bvirt - t1;
    around = _0 - avirt; u[1] = around + bround;
    u3 = (double) (_j + _i); bvirt = (double) (u3 - _j);
    avirt = u3 - bvirt; bround = _i - bvirt; around = _j - avirt;
    u[2] = around + bround;
    u[3] = u3;
    C1length = fast_expansion_sum_zeroelim(4, B, 4, u, C1);

    s1 = (double) (acx * bcytail); c = (double) (SPLITTER * acx);
    abig = (double) (c - acx); ahi = c - abig; alo = acx - ahi;
    c = (double) (SPLITTER * bcytail); abig = (double) (c - bcytail);
    bhi = c - abig; blo = bcytail - bhi; err1 = s1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    s0 = (alo * blo) - err3;
    t1 = (double) (acy * bcxtail); c = (double) (SPLITTER * acy);
    abig = (double) (c - acy); ahi = c - abig; alo = acy - ahi;
    c = (double) (SPLITTER * bcxtail); abig = (double) (c - bcxtail);
    ...
    c = (double) (SPLITTER * acytail); abig = (double) (c - acytail);
  ...
  public static final double orient3dexact (final double[] pa,
    ...
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    bxay0 = (alo * blo) - err3;
    _i = (double) (axby0 - bxay0); bvirt = (double) (axby0 - _i);
    avirt = _i + bvirt; bround = bvirt - bxay0; around = axby0 - avirt;
    ab[0] = around + bround; _j = (double) (axby1 + _i);
    bvirt = (double) (_j - axby1); avirt = _j - bvirt;
    bround = _i - bvirt; around = axby1 - avirt; _0 = around + bround;
    _i = (double) (_0 - bxay1); bvirt = (double) (_0 - _i);
    avirt = _i + bvirt; bround = bvirt - bxay1; around = _0 - avirt;
    ab[1] = around + bround; ab[3] = (double) (_j + _i);
    bvirt = (double) (ab[3] - _j); avirt = ab[3] - bvirt;
    ...
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    cxby0 = (alo * blo) - err3;
    _i = (double) (bxcy0 - cxby0); bvirt = (double) (bxcy0 - _i);
    avirt = _i + bvirt; bround = bvirt - cxby0; around = bxcy0 - avirt;
    bc[0] = around + bround; _j = (double) (bxcy1 + _i);
    bvirt = (double) (_j - bxcy1); avirt = _j - bvirt;
    bround = _i - bvirt; around = bxcy1 - avirt; _0 = around + bround;
    _i = (double) (_0 - cxby1); bvirt = (double) (_0 - _i);
    avirt = _i + bvirt; bround = bvirt - cxby1; around = _0 - avirt;
    bc[1] = around + bround; bc[3] = (double) (_j + _i);
    bvirt = (double) (bc[3] - _j); avirt = bc[3] - bvirt;
    bround = _i - bvirt; around = _j - avirt; bc[2] = around + bround;

    cxdy1 = (double) (pc[0] * pd[1]); c = (double) (SPLITTER * pc[0]);
    abig = (double) (c - pc[0]); ahi = c - abig; alo = pc[0] - ahi;
    c = (double) (SPLITTER * pd[1]); abig = (double) (c - pd[1]);
    bhi = c - abig; blo = pd[1] - bhi; err1 = cxdy1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    cxdy0 = (alo * blo) - err3;
    dxcy1 = (double) (pd[0] * pc[1]); c = (double) (SPLITTER * pd[0]);
    abig = (double) (c - pd[0]); ahi = c - abig; alo = pd[0] - ahi;
    c = (double) (SPLITTER * pc[1]); abig = (double) (c - pc[1]);
    bhi = c - abig; blo = pc[1] - bhi; err1 = dxcy1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    dxcy0 = (alo * blo) - err3;
    _i = (double) (cxdy0 - dxcy0); bvirt = (double) (cxdy0 - _i);
    avirt = _i + bvirt; bround = bvirt - dxcy0; around = cxdy0 - avirt;
    cd[0] = around + bround; _j = (double) (cxdy1 + _i);
    bvirt = (double) (_j - cxdy1); avirt = _j - bvirt;
    bround = _i - bvirt; around = cxdy1 - avirt; _0 = around + bround;
    _i = (double) (_0 - dxcy1); bvirt = (double) (_0 - _i);
    avirt = _i + bvirt; bround = bvirt - dxcy1; around = _0 - avirt;
    cd[1] = around + bround; cd[3] = (double) (_j + _i);
    bvirt = (double) (cd[3] - _j); avirt = cd[3] - bvirt;
    bround = _i - bvirt; around = _j - avirt; cd[2] = around + bround;

    dxay1 = (double) (pd[0] * pa[1]); c = (double) (SPLITTER * pd[0]);
    abig = (double) (c - pd[0]); ahi = c - abig; alo = pd[0] - ahi;
    c = (double) (SPLITTER * pa[1]); abig = (double) (c - pa[1]);
    bhi = c - abig; blo = pa[1] - bhi; err1 = dxay1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    dxay0 = (alo * blo) - err3;
    axdy1 = (double) (pa[0] * pd[1]); c = (double) (SPLITTER * pa[0]);
    abig = (double) (c - pa[0]); ahi = c - abig; alo = pa[0] - ahi;
    c = (double) (SPLITTER * pd[1]); abig = (double) (c - pd[1]);
    bhi = c - abig; blo = pd[1] - bhi; err1 = axdy1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    axdy0 = (alo * blo) - err3;
    _i = (double) (dxay0 - axdy0); bvirt = (double) (dxay0 - _i);
    avirt = _i + bvirt; bround = bvirt - axdy0; around = dxay0 - avirt;
    da[0] = around + bround; _j = (double) (dxay1 + _i);
    bvirt = (double) (_j - dxay1); avirt = _j - bvirt;
    bround = _i - bvirt; around = dxay1 - avirt; _0 = around + bround;
    _i = (double) (_0 - axdy1); bvirt = (double) (_0 - _i);
    avirt = _i + bvirt; bround = bvirt - axdy1; around = _0 - avirt;
    da[1] = around + bround; da[3] = (double) (_j + _i);
    bvirt = (double) (da[3] - _j); avirt = da[3] - bvirt;
    ...
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    cxay0 = (alo * blo) - err3;
    _i = (double) (axcy0 - cxay0); bvirt = (double) (axcy0 - _i);
    avirt = _i + bvirt; bround = bvirt - cxay0; around = axcy0 - avirt;
    ac[0] = around + bround; _j = (double) (axcy1 + _i);
    bvirt = (double) (_j - axcy1); avirt = _j - bvirt;
    bround = _i - bvirt; around = axcy1 - avirt; _0 = around + bround;
    _i = (double) (_0 - cxay1); bvirt = (double) (_0 - _i);
    avirt = _i + bvirt; bround = bvirt - cxay1; around = _0 - avirt;
    ac[1] = around + bround; ac[3] = (double) (_j + _i);
    bvirt = (double) (ac[3] - _j); avirt = ac[3] - bvirt;
    bround = _i - bvirt; around = _j - avirt; ac[2] = around + bround;

    bxdy1 = (double) (pb[0] * pd[1]); c = (double) (SPLITTER * pb[0]);
    abig = (double) (c - pb[0]); ahi = c - abig; alo = pb[0] - ahi;
    c = (double) (SPLITTER * pd[1]); abig = (double) (c - pd[1]);
    bhi = c - abig; blo = pd[1] - bhi; err1 = bxdy1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    bxdy0 = (alo * blo) - err3;
    dxby1 = (double) (pd[0] * pb[1]); c = (double) (SPLITTER * pd[0]);
    abig = (double) (c - pd[0]); ahi = c - abig; alo = pd[0] - ahi;
    c = (double) (SPLITTER * pb[1]); abig = (double) (c - pb[1]);
    bhi = c - abig; blo = pb[1] - bhi; err1 = dxby1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    dxby0 = (alo * blo) - err3;
    _i = (double) (bxdy0 - dxby0); bvirt = (double) (bxdy0 - _i);
    avirt = _i + bvirt; bround = bvirt - dxby0; around = bxdy0 - avirt;
    bd[0] = around + bround; _j = (double) (bxdy1 + _i);
    bvirt = (double) (_j - bxdy1); avirt = _j - bvirt;
    bround = _i - bvirt; around = bxdy1 - avirt; _0 = around + bround;
    _i = (double) (_0 - dxby1); bvirt = (double) (_0 - _i);
    avirt = _i + bvirt; bround = bvirt - dxby1; around = _0 - avirt;
    bd[1] = around + bround; bd[3] = (double) (_j + _i);
    bvirt = (double) (bd[3] - _j); avirt = bd[3] - bvirt;
  ...
  //--------------------------------------------------------------------
  private static final double orient3dslow (final double[] pa,
                                            final double[] pb,
                                            final double[] pc,
                                            final double[] pd) {
    ...
    adx = (double) (pa[0] - pd[0]); bvirt = (double) (pa[0] - adx);
    avirt = adx + bvirt; bround = bvirt - pd[0]; around = pa[0] - avirt;
    adxtail = around + bround;
    ady = (double) (pa[1] - pd[1]); bvirt = (double) (pa[1] - ady);
    avirt = ady + bvirt; bround = bvirt - pd[1]; around = pa[1] - avirt;
    adytail = around + bround;
    adz = (double) (pa[2] - pd[2]); bvirt = (double) (pa[2] - adz);
    avirt = adz + bvirt; bround = bvirt - pd[2]; around = pa[2] - avirt;
    adztail = around + bround;
    bdx = (double) (pb[0] - pd[0]); bvirt = (double) (pb[0] - bdx);
    avirt = bdx + bvirt; bround = bvirt - pd[0]; around = pb[0] - avirt;
    bdxtail = around + bround;
    bdy = (double) (pb[1] - pd[1]); bvirt = (double) (pb[1] - bdy);
    avirt = bdy + bvirt; bround = bvirt - pd[1]; around = pb[1] - avirt;
    bdytail = around + bround;
    bdz = (double) (pb[2] - pd[2]); bvirt = (double) (pb[2] - bdz);
    avirt = bdz + bvirt; bround = bvirt - pd[2]; around = pb[2] - avirt;
    bdztail = around + bround;
    cdx = (double) (pc[0] - pd[0]); bvirt = (double) (pc[0] - cdx);
    avirt = cdx + bvirt; bround = bvirt - pd[0]; around = pc[0] - avirt;
    cdxtail = around + bround;
    cdy = (double) (pc[1] - pd[1]); bvirt = (double) (pc[1] - cdy);
    avirt = cdy + bvirt; bround = bvirt - pd[1]; around = pc[1] - avirt;
    cdytail = around + bround;
    cdz = (double) (pc[2] - pd[2]); bvirt = (double) (pc[2] - cdz);
    avirt = cdz + bvirt; bround = bvirt - pd[2]; around = pc[2] - avirt;
    cdztail = around + bround;

    c = (double) (SPLITTER * adxtail); abig = (double) (c - adxtail);
    a0hi = c - abig; a0lo = adxtail - a0hi;
    c = (double) (SPLITTER * bdytail); abig = (double) (c - bdytail);
    bhi = c - abig; blo = bdytail - bhi;
    _i = (double) (adxtail * bdytail); err1 = _i - (a0hi * bhi);
    err2 = err1 - (a0lo * bhi); err3 = err2 - (a0hi * blo);
    axby[0] = (a0lo * blo) - err3; c = (double) (SPLITTER * adx);
    abig = (double) (c - adx); a1hi = c - abig; a1lo = adx - a1hi;
    _j = (double) (adx * bdytail); err1 = _j - (a1hi * bhi);
    err2 = err1 - (a1lo * bhi); err3 = err2 - (a1hi * blo);
    _0 = (a1lo * blo) - err3; _k = (double) (_i + _0);
    bvirt = (double) (_k - _i); avirt = _k - bvirt; bround = _0 - bvirt;
    around = _i - avirt; _1 = around + bround; _l = (double) (_j + _k);
    bvirt = _l - _j; _2 = _k - bvirt; c = (double) (SPLITTER * bdy);
    abig = (double) (c - bdy); bhi = c - abig; blo = bdy - bhi;
    _i = (double) (adxtail * bdy); err1 = _i - (a0hi * bhi);
    err2 = err1 - (a0lo * bhi); err3 = err2 - (a0hi * blo);
    _0 = (a0lo * blo) - err3; _k = (double) (_1 + _0);
    bvirt = (double) (_k - _1); avirt = _k - bvirt; bround = _0 - bvirt;
    around = _1 - avirt; axby[1] = around + bround;
    ...
    bvirt = (double) (_m - _l); avirt = _m - bvirt; bround = _j - bvirt;
    around = _l - avirt; _2 = around + bround;
    _j = (double) (adx * bdy); err1 = _j - (a1hi * bhi);
    err2 = err1 - (a1lo * bhi); err3 = err2 - (a1hi * blo);
    _0 = (a1lo * blo) - err3; _n = (double) (_i + _0);
    bvirt = (double) (_n - _i); avirt = _n - bvirt; bround = _0 - bvirt;
    around = _i - avirt; _0 = around + bround; _i = (double) (_1 + _0);
    ...
    negate = -ady;
    negatetail = -adytail;
    c = (double) (SPLITTER * bdxtail); abig = (double) (c - bdxtail);
    a0hi = c - abig; a0lo = bdxtail - a0hi;
    c = (double) (SPLITTER * negatetail);
    abig = (double) (c - negatetail); bhi = c - abig;
    blo = negatetail - bhi; _i = (double) (bdxtail * negatetail);
    err1 = _i - (a0hi * bhi); err2 = err1 - (a0lo * bhi);
    err3 = err2 - (a0hi * blo); bxay[0] = (a0lo * blo) - err3;
    c = (double) (SPLITTER * bdx); abig = (double) (c - bdx);
    a1hi = c - abig; a1lo = bdx - a1hi;
    _j = (double) (bdx * negatetail); err1 = _j - (a1hi * bhi);
    err2 = err1 - (a1lo * bhi); err3 = err2 - (a1hi * blo);
    _0 = (a1lo * blo) - err3; _k = (double) (_i + _0);
    bvirt = (double) (_k - _i); avirt = _k - bvirt; bround = _0 - bvirt;
    around = _i - avirt; _1 = around + bround; _l = (double) (_j + _k);
    bvirt = _l - _j; _2 = _k - bvirt; c = (double) (SPLITTER * negate);
    abig = (double) (c - negate); bhi = c - abig; blo = negate - bhi;
    _i = (double) (bdxtail * negate); err1 = _i - (a0hi * bhi);
    err2 = err1 - (a0lo * bhi); err3 = err2 - (a0hi * blo);
    _0 = (a0lo * blo) - err3; _k = (double) (_1 + _0);
    bvirt = (double) (_k - _1); avirt = _k - bvirt; bround = _0 - bvirt;
    around = _1 - avirt; bxay[1] = around + bround;
    ...
    bvirt = (double) (_m - _l); avirt = _m - bvirt; bround = _j - bvirt;
    around = _l - avirt; _2 = around + bround;
    _j = (double) (bdx * negate); err1 = _j - (a1hi * bhi);
    err2 = err1 - (a1lo * bhi); err3 = err2 - (a1hi * blo);
    _0 = (a1lo * blo) - err3; _n = (double) (_i + _0);
    bvirt = (double) (_n - _i); avirt = _n - bvirt; bround = _0 - bvirt;
    around = _i - avirt; _0 = around + bround; _i = (double) (_1 + _0);
    ...
    c = (double) (SPLITTER * bdxtail); abig = (double) (c - bdxtail);
    a0hi = c - abig; a0lo = bdxtail - a0hi;
    c = (double) (SPLITTER * cdytail); abig = (double) (c - cdytail);
    bhi = c - abig; blo = cdytail - bhi;
    _i = (double) (bdxtail * cdytail); err1 = _i - (a0hi * bhi);
    err2 = err1 - (a0lo * bhi); err3 = err2 - (a0hi * blo);
    bxcy[0] = (a0lo * blo) - err3; c = (double) (SPLITTER * bdx);
    abig = (double) (c - bdx); a1hi = c - abig; a1lo = bdx - a1hi;
    _j = (double) (bdx * cdytail); err1 = _j - (a1hi * bhi);
    err2 = err1 - (a1lo * bhi); err3 = err2 - (a1hi * blo);
    _0 = (a1lo * blo) - err3; _k = (double) (_i + _0);
    bvirt = (double) (_k - _i); avirt = _k - bvirt; bround = _0 - bvirt;
    around = _i - avirt; _1 = around + bround; _l = (double) (_j + _k);
    bvirt = _l - _j; _2 = _k - bvirt; c = (double) (SPLITTER * cdy);
    abig = (double) (c - cdy); bhi = c - abig; blo = cdy - bhi;
    _i = (double) (bdxtail * cdy); err1 = _i - (a0hi * bhi);
    err2 = err1 - (a0lo * bhi); err3 = err2 - (a0hi * blo);
    _0 = (a0lo * blo) - err3; _k = (double) (_1 + _0);
    bvirt = (double) (_k - _1); avirt = _k - bvirt; bround = _0 - bvirt;
    ...
    bvirt = (double) (_m - _l); avirt = _m - bvirt; bround = _j - bvirt;
    around = _l - avirt; _2 = around + bround;
    _j = (double) (bdx * cdy); err1 = _j - (a1hi * bhi);
    err2 = err1 - (a1lo * bhi); err3 = err2 - (a1hi * blo);
    _0 = (a1lo * blo) - err3; _n = (double) (_i + _0);
    bvirt = (double) (_n - _i); avirt = _n - bvirt; bround = _0 - bvirt;
    around = _i - avirt; _0 = around + bround; _i = (double) (_1 + _0);
    ...
    _k = (double) (_2 + _i); bvirt = (double) (_k - _2);
    avirt = _k - bvirt; bround = _i - bvirt; around = _2 - avirt;
    bxcy[5] = around + bround; bxcy7 = (double) (_m + _k);
    bvirt = (double) (bxcy7 - _m); avirt = bxcy7 - bvirt;
    ...
    c = (double) (SPLITTER * negatetail);
    abig = (double) (c - negatetail); bhi = c - abig;
    blo = negatetail - bhi; _i = (double) (cdxtail * negatetail);
    err1 = _i - (a0hi * bhi); err2 = err1 - (a0lo * bhi);
    err3 = err2 - (a0hi * blo); cxby[0] = (a0lo * blo) - err3;
    c = (double) (SPLITTER * cdx); abig = (double) (c - cdx);
    a1hi = c - abig; a1lo = cdx - a1hi;
    _j = (double) (cdx * negatetail); err1 = _j - (a1hi * bhi);
    err2 = err1 - (a1lo * bhi); err3 = err2 - (a1hi * blo);
    _0 = (a1lo * blo) - err3; _k = (double) (_i + _0);
    bvirt = (double) (_k - _i); avirt = _k - bvirt; bround = _0 - bvirt;
    around = _i - avirt; _1 = around + bround; _l = (double) (_j + _k);
    bvirt = _l - _j; _2 = _k - bvirt; c = (double) (SPLITTER * negate);
    abig = (double) (c - negate); bhi = c - abig; blo = negate - bhi;
    _i = (double) (cdxtail * negate); err1 = _i - (a0hi * bhi);
    err2 = err1 - (a0lo * bhi); err3 = err2 - (a0hi * blo);
    _0 = (a0lo * blo) - err3; _k = (double) (_1 + _0);
    bvirt = (double) (_k - _1); avirt = _k - bvirt; bround = _0 - bvirt;
    ...
    bvirt = (double) (_m - _l); avirt = _m - bvirt; bround = _j - bvirt;
    around = _l - avirt; _2 = around + bround;
    _j = (double) (cdx * negate); err1 = _j - (a1hi * bhi);
    err2 = err1 - (a1lo * bhi); err3 = err2 - (a1hi * blo);
    _0 = (a1lo * blo) - err3; _n = (double) (_i + _0);
    bvirt = (double) (_n - _i); avirt = _n - bvirt; bround = _0 - bvirt;
    around = _i - avirt; _0 = around + bround; _i = (double) (_1 + _0);
    ...
    _k = (double) (_2 + _i); bvirt = (double) (_k - _2);
    avirt = _k - bvirt; bround = _i - bvirt; around = _2 - avirt;
    cxby[5] = around + bround; cxby7 = (double) (_m + _k);
    bvirt = (double) (cxby7 - _m); avirt = cxby7 - bvirt;
    ...
    c = (double) (SPLITTER * cdxtail); abig = (double) (c - cdxtail);
    a0hi = c - abig; a0lo = cdxtail - a0hi;
    c = (double) (SPLITTER * adytail); abig = (double) (c - adytail);
    bhi = c - abig; blo = adytail - bhi;
    _i = (double) (cdxtail * adytail); err1 = _i - (a0hi * bhi);
    err2 = err1 - (a0lo * bhi); err3 = err2 - (a0hi * blo);
    cxay[0] = (a0lo * blo) - err3; c = (double) (SPLITTER * cdx);
    abig = (double) (c - cdx); a1hi = c - abig; a1lo = cdx - a1hi;
    _j = (double) (cdx * adytail); err1 = _j - (a1hi * bhi);
    err2 = err1 - (a1lo * bhi); err3 = err2 - (a1hi * blo);
    _0 = (a1lo * blo) - err3; _k = (double) (_i + _0);
    bvirt = (double) (_k - _i); avirt = _k - bvirt; bround = _0 - bvirt;
    around = _i - avirt; _1 = around + bround; _l = (double) (_j + _k);
    bvirt = _l - _j; _2 = _k - bvirt; c = (double) (SPLITTER * ady);
    abig = (double) (c - ady); bhi = c - abig; blo = ady - bhi;
    _i = (double) (cdxtail * ady); err1 = _i - (a0hi * bhi);
    err2 = err1 - (a0lo * bhi); err3 = err2 - (a0hi * blo);
    _0 = (a0lo * blo) - err3; _k = (double) (_1 + _0);
    bvirt = (double) (_k - _1); avirt = _k - bvirt; bround = _0 - bvirt;
    ...
    bvirt = (double) (_m - _l); avirt = _m - bvirt; bround = _j - bvirt;
    around = _l - avirt; _2 = around + bround;
    _j = (double) (cdx * ady); err1 = _j - (a1hi * bhi);
    err2 = err1 - (a1lo * bhi); err3 = err2 - (a1hi * blo);
    _0 = (a1lo * blo) - err3; _n = (double) (_i + _0);
    bvirt = (double) (_n - _i); avirt = _n - bvirt; bround = _0 - bvirt;
    around = _i - avirt; _0 = around + bround; _i = (double) (_1 + _0);
    ...
    _k = (double) (_2 + _i); bvirt = (double) (_k - _2);
    avirt = _k - bvirt; bround = _i - bvirt; around = _2 - avirt;
    cxay[5] = around + bround; cxay7 = (double) (_m + _k);
    bvirt = (double) (cxay7 - _m); avirt = cxay7 - bvirt;
    ...
    c = (double) (SPLITTER * negatetail);
    abig = (double) (c - negatetail); bhi = c - abig;
    blo = negatetail - bhi; _i = (double) (adxtail * negatetail);
    err1 = _i - (a0hi * bhi); err2 = err1 - (a0lo * bhi);
    err3 = err2 - (a0hi * blo); axcy[0] = (a0lo * blo) - err3;
    c = (double) (SPLITTER * adx); abig = (double) (c - adx);
    a1hi = c - abig; a1lo = adx - a1hi;
    _j = (double) (adx * negatetail); err1 = _j - (a1hi * bhi);
    err2 = err1 - (a1lo * bhi); err3 = err2 - (a1hi * blo);
    _0 = (a1lo * blo) - err3; _k = (double) (_i + _0);
    bvirt = (double) (_k - _i); avirt = _k - bvirt; bround = _0 - bvirt;
    around = _i - avirt; _1 = around + bround; _l = (double) (_j + _k);
    bvirt = _l - _j; _2 = _k - bvirt; c = (double) (SPLITTER * negate);
    abig = (double) (c - negate); bhi = c - abig; blo = negate - bhi;
    _i = (double) (adxtail * negate); err1 = _i - (a0hi * bhi);
    err2 = err1 - (a0lo * bhi); err3 = err2 - (a0hi * blo);
    _0 = (a0lo * blo) - err3; _k = (double) (_1 + _0);
    bvirt = (double) (_k - _1); avirt = _k - bvirt; bround = _0 - bvirt;
    ...
    bvirt = (double) (_m - _l); avirt = _m - bvirt; bround = _j - bvirt;
    around = _l - avirt; _2 = around + bround;
    _j = (double) (adx * negate); err1 = _j - (a1hi * bhi);
    err2 = err1 - (a1lo * bhi); err3 = err2 - (a1hi * blo);
    _0 = (a1lo * blo) - err3; _n = (double) (_i + _0);
    bvirt = (double) (_n - _i); avirt = _n - bvirt; bround = _0 - bvirt;
    around = _i - avirt; _0 = around + bround; _i = (double) (_1 + _0);
    ...
    _k = (double) (_2 + _i); bvirt = (double) (_k - _2);
    avirt = _k - bvirt; bround = _i - bvirt; around = _2 - avirt;
    axcy[5] = around + bround; axcy7 = (double) (_m + _k);
    bvirt = (double) (axcy7 - _m); avirt = axcy7 - bvirt;
  ...
  private static final double orient3dadapt (final double[] pa,
    ...
    bdxcdy1 = (double) (bdx * cdy); c = (double) (SPLITTER * bdx);
    abig = (double) (c - bdx); ahi = c - abig; alo = bdx - ahi;
    c = (double) (SPLITTER * cdy); abig = (double) (c - cdy);
    bhi = c - abig; blo = cdy - bhi; err1 = bdxcdy1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    bdxcdy0 = (alo * blo) - err3;
    cdxbdy1 = (double) (cdx * bdy); c = (double) (SPLITTER * cdx);
    abig = (double) (c - cdx); ahi = c - abig; alo = cdx - ahi;
    c = (double) (SPLITTER * bdy); abig = (double) (c - bdy);
    bhi = c - abig; blo = bdy - bhi; err1 = cdxbdy1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    cdxbdy0 = (alo * blo) - err3;
    _i = (double) (bdxcdy0 - cdxbdy0); bvirt = (double) (bdxcdy0 - _i);
    avirt = _i + bvirt; bround = bvirt - cdxbdy0;
    around = bdxcdy0 - avirt; bc[0] = around + bround;
    _j = (double) (bdxcdy1 + _i); bvirt = (double) (_j - bdxcdy1);
    avirt = _j - bvirt; bround = _i - bvirt; around = bdxcdy1 - avirt;
    _0 = around + bround; _i = (double) (_0 - cdxbdy1);
    bvirt = (double) (_0 - _i); avirt = _i + bvirt;
    bround = bvirt - cdxbdy1; around = _0 - avirt;
    bc[1] = around + bround; bc3 = (double) (_j + _i);
    bvirt = (double) (bc3 - _j); avirt = bc3 - bvirt;
    bround = _i - bvirt; around = _j - avirt; bc[2] = around + bround;
    bc[3] = bc3;
    alen = scale_expansion_zeroelim(4, bc, adz, adet);

    cdxady1 = (double) (cdx * ady); c = (double) (SPLITTER * cdx);
    abig = (double) (c - cdx); ahi = c - abig; alo = cdx - ahi;
    c = (double) (SPLITTER * ady); abig = (double) (c - ady);
    bhi = c - abig; blo = ady - bhi; err1 = cdxady1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    cdxady0 = (alo * blo) - err3;
    adxcdy1 = (double) (adx * cdy); c = (double) (SPLITTER * adx);
    abig = (double) (c - adx); ahi = c - abig; alo = adx - ahi;
    c = (double) (SPLITTER * cdy); abig = (double) (c - cdy);
    bhi = c - abig; blo = cdy - bhi; err1 = adxcdy1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    adxcdy0 = (alo * blo) - err3;
    _i = (double) (cdxady0 - adxcdy0); bvirt = (double) (cdxady0 - _i);
    avirt = _i + bvirt; bround = bvirt - adxcdy0;
    around = cdxady0 - avirt; ca[0] = around + bround;
    _j = (double) (cdxady1 + _i); bvirt = (double) (_j - cdxady1);
    avirt = _j - bvirt; bround = _i - bvirt; around = cdxady1 - avirt;
    _0 = around + bround; _i = (double) (_0 - adxcdy1);
    bvirt = (double) (_0 - _i); avirt = _i + bvirt;
    bround = bvirt - adxcdy1; around = _0 - avirt;
    ca[1] = around + bround; ca3 = (double) (_j + _i);
    bvirt = (double) (ca3 - _j); avirt = ca3 - bvirt;
    bround = _i - bvirt; around = _j - avirt; ca[2] = around + bround;
    ca[3] = ca3;
    blen = scale_expansion_zeroelim(4, ca, bdz, bdet);

    adxbdy1 = (double) (adx * bdy); c = (double) (SPLITTER * adx);
    abig = (double) (c - adx); ahi = c - abig; alo = adx - ahi;
    c = (double) (SPLITTER * bdy); abig = (double) (c - bdy);
    bhi = c - abig; blo = bdy - bhi; err1 = adxbdy1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    adxbdy0 = (alo * blo) - err3;
    bdxady1 = (double) (bdx * ady); c = (double) (SPLITTER * bdx);
    abig = (double) (c - bdx); ahi = c - abig; alo = bdx - ahi;
    c = (double) (SPLITTER * ady); abig = (double) (c - ady);
    bhi = c - abig; blo = ady - bhi; err1 = bdxady1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    bdxady0 = (alo * blo) - err3;
    _i = (double) (adxbdy0 - bdxady0); bvirt = (double) (adxbdy0 - _i);
    avirt = _i + bvirt; bround = bvirt - bdxady0;
    around = adxbdy0 - avirt; ab[0] = around + bround;
    _j = (double) (adxbdy1 + _i); bvirt = (double) (_j - adxbdy1);
    avirt = _j - bvirt; bround = _i - bvirt; around = adxbdy1 - avirt;
    _0 = around + bround; _i = (double) (_0 - bdxady1);
    bvirt = (double) (_0 - _i); avirt = _i + bvirt;
    bround = bvirt - bdxady1; around = _0 - avirt;
    ab[1] = around + bround; ab3 = (double) (_j + _i);
    bvirt = (double) (ab3 - _j); avirt = ab3 - bvirt;
    bround = _i - bvirt; around = _j - avirt; ab[2] = around + bround;
    ab[3] = ab3;
    ...
    bvirt = (double) (pa[0] - adx); avirt = adx + bvirt;
    bround = bvirt - pd[0]; around = pa[0] - avirt;
    adxtail = around + bround;
    bvirt = (double) (pb[0] - bdx); avirt = bdx + bvirt;
    bround = bvirt - pd[0]; around = pb[0] - avirt;
    bdxtail = around + bround;
    bvirt = (double) (pc[0] - cdx); avirt = cdx + bvirt;
    bround = bvirt - pd[0]; around = pc[0] - avirt;
    cdxtail = around + bround;
    bvirt = (double) (pa[1] - ady); avirt = ady + bvirt;
    bround = bvirt - pd[1]; around = pa[1] - avirt;
    adytail = around + bround;
    bvirt = (double) (pb[1] - bdy); avirt = bdy + bvirt;
    bround = bvirt - pd[1]; around = pb[1] - avirt;
    bdytail = around + bround;
    bvirt = (double) (pc[1] - cdy); avirt = cdy + bvirt;
    bround = bvirt - pd[1]; around = pc[1] - avirt;
    cdytail = around + bround;
    bvirt = (double) (pa[2] - adz); avirt = adz + bvirt;
    bround = bvirt - pd[2]; around = pa[2] - avirt;
    adztail = around + bround;
    bvirt = (double) (pb[2] - bdz); avirt = bdz + bvirt;
    bround = bvirt - pd[2]; around = pb[2] - avirt;
    bdztail = around + bround;
    bvirt = (double) (pc[2] - cdz); avirt = cdz + bvirt;
    ...
    if (adxtail == 0.0) {
      if (adytail == 0.0) {
        ...
        c = (double) (SPLITTER * negate); abig = (double) (c - negate);
        ...
        abig = (double) (c - adytail); ahi = c - abig;
        alo = adytail - ahi; c = (double) (SPLITTER * cdx);
        abig = (double) (c - cdx); bhi = c - abig; blo = cdx - bhi;
      ...
      if (adytail == 0.0) {
        ...
        abig = (double) (c - adxtail); ahi = c - abig;
        alo = adxtail - ahi; c = (double) (SPLITTER * bdy);
        abig = (double) (c - bdy); bhi = c - abig; blo = bdy - bhi;
        ...
        c = (double) (SPLITTER * adytail);
        abig = (double) (c - adytail); ahi = c - abig;
        alo = adytail - ahi; c = (double) (SPLITTER * bdx);
        abig = (double) (c - bdx); bhi = c - abig; blo = bdx - bhi;
        err1 = adyt_bdx1 - (ahi * bhi); err2 = err1 - (alo * bhi);
        err3 = err2 - (ahi * blo); adyt_bdx0 = (alo * blo) - err3;
        _i = (double) (adxt_bdy0 - adyt_bdx0);
        bvirt = (double) (adxt_bdy0 - _i); avirt = _i + bvirt;
        bround = bvirt - adyt_bdx0; around = adxt_bdy0 - avirt;
        at_b[0] = around + bround; _j = (double) (adxt_bdy1 + _i);
        bvirt = (double) (_j - adxt_bdy1); avirt = _j - bvirt;
        bround = _i - bvirt; around = adxt_bdy1 - avirt;
        _0 = around + bround; _i = (double) (_0 - adyt_bdx1);
        bvirt = (double) (_0 - _i); avirt = _i + bvirt;
        bround = bvirt - adyt_bdx1; around = _0 - avirt;
        at_b[1] = around + bround; at_blarge = (double) (_j + _i);
        bvirt = (double) (at_blarge - _j); avirt = at_blarge - bvirt;
        bround = _i - bvirt; around = _j - avirt;
        ...
        c = (double) (SPLITTER * adxtail);
        abig = (double) (c - adxtail); ahi = c - abig;
        alo = adxtail - ahi; c = (double) (SPLITTER * cdy);
        abig = (double) (c - cdy); bhi = c - abig; blo = cdy - bhi;
        err1 = adxt_cdy1 - (ahi * bhi); err2 = err1 - (alo * bhi);
        err3 = err2 - (ahi * blo); adxt_cdy0 = (alo * blo) - err3;
        _i = (double) (adyt_cdx0 - adxt_cdy0);
        bvirt = (double) (adyt_cdx0 - _i); avirt = _i + bvirt;
        bround = bvirt - adxt_cdy0; around = adyt_cdx0 - avirt;
        at_c[0] = around + bround; _j = (double) (adyt_cdx1 + _i);
        bvirt = (double) (_j - adyt_cdx1); avirt = _j - bvirt;
        bround = _i - bvirt; around = adyt_cdx1 - avirt;
        _0 = around + bround; _i = (double) (_0 - adxt_cdy1);
        bvirt = (double) (_0 - _i); avirt = _i + bvirt;
        bround = bvirt - adxt_cdy1; around = _0 - avirt;
        at_c[1] = around + bround; at_clarge = (double) (_j + _i);
        bvirt = (double) (at_clarge - _j); avirt = at_clarge - bvirt;
        bround = _i - bvirt; around = _j - avirt;
    ...
    if (bdxtail == 0.0) {
      if (bdytail == 0.0) {
        ...
        abig = (double) (c - bdytail); ahi = c - abig;
        alo = bdytail - ahi; c = (double) (SPLITTER * adx);
        abig = (double) (c - adx); bhi = c - abig; blo = adx - bhi;
      ...
      if (bdytail == 0.0) {
        ...
        abig = (double) (c - bdxtail); ahi = c - abig;
        alo = bdxtail - ahi; c = (double) (SPLITTER * cdy);
        abig = (double) (c - cdy); bhi = c - abig; blo = cdy - bhi;
        ...
        c = (double) (SPLITTER * bdytail);
        abig = (double) (c - bdytail); ahi = c - abig;
        alo = bdytail - ahi; c = (double) (SPLITTER * cdx);
        abig = (double) (c - cdx); bhi = c - abig; blo = cdx - bhi;
        err1 = bdyt_cdx1 - (ahi * bhi); err2 = err1 - (alo * bhi);
        err3 = err2 - (ahi * blo); bdyt_cdx0 = (alo * blo) - err3;
        _i = (double) (bdxt_cdy0 - bdyt_cdx0);
        bvirt = (double) (bdxt_cdy0 - _i); avirt = _i + bvirt;
        bround = bvirt - bdyt_cdx0; around = bdxt_cdy0 - avirt;
        bt_c[0] = around + bround; _j = (double) (bdxt_cdy1 + _i);
        bvirt = (double) (_j - bdxt_cdy1); avirt = _j - bvirt;
        bround = _i - bvirt; around = bdxt_cdy1 - avirt;
        _0 = around + bround; _i = (double) (_0 - bdyt_cdx1);
        bvirt = (double) (_0 - _i); avirt = _i + bvirt;
        bround = bvirt - bdyt_cdx1; around = _0 - avirt;
        bt_c[1] = around + bround; bt_clarge = (double) (_j + _i);
        bvirt = (double) (bt_clarge - _j); avirt = bt_clarge - bvirt;
        bround = _i - bvirt; around = _j - avirt;
        ...
        c = (double) (SPLITTER * bdxtail);
        abig = (double) (c - bdxtail); ahi = c - abig;
        alo = bdxtail - ahi; c = (double) (SPLITTER * ady);
        abig = (double) (c - ady); bhi = c - abig; blo = ady - bhi;
        err1 = bdxt_ady1 - (ahi * bhi); err2 = err1 - (alo * bhi);
        err3 = err2 - (ahi * blo); bdxt_ady0 = (alo * blo) - err3;
        _i = (double) (bdyt_adx0 - bdxt_ady0);
        bvirt = (double) (bdyt_adx0 - _i); avirt = _i + bvirt;
        bround = bvirt - bdxt_ady0; around = bdyt_adx0 - avirt;
        bt_a[0] = around + bround; _j = (double) (bdyt_adx1 + _i);
        bvirt = (double) (_j - bdyt_adx1); avirt = _j - bvirt;
        bround = _i - bvirt; around = bdyt_adx1 - avirt;
        _0 = around + bround; _i = (double) (_0 - bdxt_ady1);
        bvirt = (double) (_0 - _i); avirt = _i + bvirt;
        bround = bvirt - bdxt_ady1; around = _0 - avirt;
        bt_a[1] = around + bround; bt_alarge = (double) (_j + _i);
        bvirt = (double) (bt_alarge - _j); avirt = bt_alarge - bvirt;
        bround = _i - bvirt; around = _j - avirt;
    ...
    if (cdxtail == 0.0) {
      if (cdytail == 0.0) {
        ...
        abig = (double) (c - cdytail); ahi = c - abig;
        alo = cdytail - ahi; c = (double) (SPLITTER * bdx);
        abig = (double) (c - bdx); bhi = c - abig; blo = bdx - bhi;
      ...
      if (cdytail == 0.0) {
        ...
        abig = (double) (c - cdxtail); ahi = c - abig;
        alo = cdxtail - ahi; c = (double) (SPLITTER * ady);
        abig = (double) (c - ady); bhi = c - abig; blo = ady - bhi;
        ...
        c = (double) (SPLITTER * cdytail);
        abig = (double) (c - cdytail); ahi = c - abig;
        alo = cdytail - ahi; c = (double) (SPLITTER * adx);
        abig = (double) (c - adx); bhi = c - abig; blo = adx - bhi;
        err1 = cdyt_adx1 - (ahi * bhi); err2 = err1 - (alo * bhi);
        err3 = err2 - (ahi * blo); cdyt_adx0 = (alo * blo) - err3;
        _i = (double) (cdxt_ady0 - cdyt_adx0);
        bvirt = (double) (cdxt_ady0 - _i); avirt = _i + bvirt;
        bround = bvirt - cdyt_adx0; around = cdxt_ady0 - avirt;
        ct_a[0] = around + bround; _j = (double) (cdxt_ady1 + _i);
        bvirt = (double) (_j - cdxt_ady1); avirt = _j - bvirt;
        bround = _i - bvirt; around = cdxt_ady1 - avirt;
        _0 = around + bround; _i = (double) (_0 - cdyt_adx1);
        bvirt = (double) (_0 - _i); avirt = _i + bvirt;
        bround = bvirt - cdyt_adx1; around = _0 - avirt;
        ct_a[1] = around + bround; ct_alarge = (double) (_j + _i);
        bvirt = (double) (ct_alarge - _j); avirt = ct_alarge - bvirt;
        bround = _i - bvirt; around = _j - avirt;
        ...
        c = (double) (SPLITTER * cdxtail);
        abig = (double) (c - cdxtail); ahi = c - abig;
        alo = cdxtail - ahi; c = (double) (SPLITTER * bdy);
        abig = (double) (c - bdy); bhi = c - abig; blo = bdy - bhi;
        err1 = cdxt_bdy1 - (ahi * bhi); err2 = err1 - (alo * bhi);
        err3 = err2 - (ahi * blo); cdxt_bdy0 = (alo * blo) - err3;
        _i = (double) (cdyt_bdx0 - cdxt_bdy0);
        bvirt = (double) (cdyt_bdx0 - _i); avirt = _i + bvirt;
        bround = bvirt - cdxt_bdy0; around = cdyt_bdx0 - avirt;
        ct_b[0] = around + bround; _j = (double) (cdyt_bdx1 + _i);
        bvirt = (double) (_j - cdyt_bdx1); avirt = _j - bvirt;
        bround = _i - bvirt; around = cdyt_bdx1 - avirt;
        _0 = around + bround; _i = (double) (_0 - cdxt_bdy1);
        bvirt = (double) (_0 - _i); avirt = _i + bvirt;
        bround = bvirt - cdxt_bdy1; around = _0 - avirt;
        ct_b[1] = around + bround; ct_blarge = (double) (_j + _i);
        bvirt = (double) (ct_blarge - _j); avirt = ct_blarge - bvirt;
        bround = _i - bvirt; around = _j - avirt;
    ...
    if (adxtail != 0.0) {
      if (bdytail != 0.0) {
        ...
        c = (double) (SPLITTER * adxtail);
        abig = (double) (c - adxtail); ahi = c - abig;
        alo = adxtail - ahi; c = (double) (SPLITTER * bdytail);
        abig = (double) (c - bdytail); bhi = c - abig;
        blo = bdytail - bhi; err1 = adxt_bdyt1 - (ahi * bhi);
        err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
        adxt_bdyt0 = (alo * blo) - err3;
        c = (double) (SPLITTER * cdz); abig = (double) (c - cdz);
        bhi = c - abig; blo = cdz - bhi;
        _i = (double) (adxt_bdyt0 * cdz);
        c = (double) (SPLITTER * adxt_bdyt0);
        abig = (double) (c - adxt_bdyt0); ahi = c - abig;
        alo = adxt_bdyt0 - ahi; err1 = _i - (ahi * bhi);
        err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
        u[0] = (alo * blo) - err3; _j = (double) (adxt_bdyt1 * cdz);
        c = (double) (SPLITTER * adxt_bdyt1);
        abig = (double) (c - adxt_bdyt1); ahi = c - abig;
        alo = adxt_bdyt1 - ahi; err1 = _j - (ahi * bhi);
        err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
        _0 = (alo * blo) - err3; _k = (double) (_i + _0);
        bvirt = (double) (_k - _i); avirt = _k - bvirt;
        bround = _0 - bvirt; around = _i - avirt;
        u[1] = around + bround; u3 = (double) (_j + _k);
        ...
        if (cdztail != 0.0) {
          ...
          abig = (double) (c - cdztail); bhi = c - abig;
          blo = cdztail - bhi; _i = (double) (adxt_bdyt0 * cdztail);
          c = (double) (SPLITTER * adxt_bdyt0);
          abig = (double) (c - adxt_bdyt0); ahi = c - abig;
          alo = adxt_bdyt0 - ahi; err1 = _i - (ahi * bhi);
          err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
      ...
      if (cdytail != 0.0) {
        ...
        if (bdztail != 0.0) {
          ...
          abig = (double) (c - bdztail); bhi = c - abig;
          blo = bdztail - bhi; _i = (double) (adxt_cdyt0 * bdztail);
          c = (double) (SPLITTER * adxt_cdyt0);
          abig = (double) (c - adxt_cdyt0); ahi = c - abig;
          alo = adxt_cdyt0 - ahi; err1 = _i - (ahi * bhi);
          err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    ...
    if (bdxtail != 0.0) {
      if (cdytail != 0.0) {
        ...
        if (adztail != 0.0) {
          ...
          abig = (double) (c - adztail); bhi = c - abig;
          blo = adztail - bhi; _i = (double) (bdxt_cdyt0 * adztail);
          c = (double) (SPLITTER * bdxt_cdyt0);
          abig = (double) (c - bdxt_cdyt0); ahi = c - abig;
          alo = bdxt_cdyt0 - ahi; err1 = _i - (ahi * bhi);
          err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
      ...
      if (adytail != 0.0) {
        ...
        ahi = c - abig; alo = negate - ahi;
        c = (double) (SPLITTER * adytail);
        abig = (double) (c - adytail); bhi = c - abig;
        ...
        abig = (double) (c - bdxt_adyt0); ahi = c - abig;
        alo = bdxt_adyt0 - ahi; err1 = _i - (ahi * bhi);
        err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
        u[0] = (alo * blo) - err3; _j = (double) (bdxt_adyt1 * cdz);
        c = (double) (SPLITTER * bdxt_adyt1);
        abig = (double) (c - bdxt_adyt1); ahi = c - abig;
        ...
        if (cdztail != 0.0) {
          c = (double) (SPLITTER * cdztail);
          abig = (double) (c - cdztail); bhi = c - abig;
          blo = cdztail - bhi; _i = (double) (bdxt_adyt0 * cdztail);
          c = (double) (SPLITTER * bdxt_adyt0);
          abig = (double) (c - bdxt_adyt0); ahi = c - abig;
          alo = bdxt_adyt0 - ahi; err1 = _i - (ahi * bhi);
          err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    ...
    if (cdxtail != 0.0) {
      if (adytail != 0.0) {
        ...
        c = (double) (SPLITTER * cdxtail);
        abig = (double) (c - cdxtail); ahi = c - abig;
        alo = cdxtail - ahi; c = (double) (SPLITTER * adytail);
        abig = (double) (c - adytail); bhi = c - abig;
        ...
        abig = (double) (c - cdxt_adyt0); ahi = c - abig;
        alo = cdxt_adyt0 - ahi; err1 = _i - (ahi * bhi);
        err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
        u[0] = (alo * blo) - err3; _j = (double) (cdxt_adyt1 * bdz);
        c = (double) (SPLITTER * cdxt_adyt1);
        abig = (double) (c - cdxt_adyt1); ahi = c - abig;
        ...
        if (bdztail != 0.0) {
          c = (double) (SPLITTER * bdztail);
          abig = (double) (c - bdztail); bhi = c - abig;
          blo = bdztail - bhi; _i = (double) (cdxt_adyt0 * bdztail);
          c = (double) (SPLITTER * cdxt_adyt0);
          abig = (double) (c - cdxt_adyt0); ahi = c - abig;
          alo = cdxt_adyt0 - ahi; err1 = _i - (ahi * bhi);
          err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
      ...
      if (bdytail != 0.0) {
        ...
        abig = (double) (c - cdxt_bdyt0); ahi = c - abig;
        alo = cdxt_bdyt0 - ahi; err1 = _i - (ahi * bhi);
        err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
        u[0] = (alo * blo) - err3; _j = (double) (cdxt_bdyt1 * adz);
        c = (double) (SPLITTER * cdxt_bdyt1);
        abig = (double) (c - cdxt_bdyt1); ahi = c - abig;
        ...
        if (adztail != 0.0) {
          c = (double) (SPLITTER * adztail);
          abig = (double) (c - adztail); bhi = c - abig;
          blo = adztail - bhi; _i = (double) (cdxt_bdyt0 * adztail);
          c = (double) (SPLITTER * cdxt_bdyt0);
          abig = (double) (c - cdxt_bdyt0); ahi = c - abig;
          alo = cdxt_bdyt0 - ahi; err1 = _i - (ahi * bhi);
          err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
  ...
  //--------------------------------------------------------------------
  private static final double orient3d (final double[] pa,
                                        final double[] pb,
                                        final double[] pc,
                                        final double[] pd) {
    double adx, bdx, cdx, ady, bdy, cdy, adz, bdz, cdz;
  ...
  //--------------------------------------------------------------------
  private static final double incirclefast (final double[] pa,
                                            final double[] pb,
                                            final double[] pc,
                                            final double[] pd) {
  ...
  //--------------------------------------------------------------------
  private static final double incircleexact (final double[] pa,
                        final double[] pb,
                        final double[] pc,
                        final double[] pd) {
    double axby1, bxcy1, cxdy1, dxay1, axcy1, bxdy1;
    ...
    alen =
      fast_expansion_sum_zeroelim(xlen, det48x, ylen, det48y, adet);
    ...
    blen =
      fast_expansion_sum_zeroelim(xlen, det48x, ylen, det48y, bdet);
    ...
    clen =
      fast_expansion_sum_zeroelim(xlen, det48x, ylen, det48y, cdet);
    ...
    dlen =
      fast_expansion_sum_zeroelim(xlen, det48x, ylen, det48y, ddet);
  ...
  //--------------------------------------------------------------------
 private static final  double incircleslow (final double[] pa,
                      final double[] pb,
                      final double[] pc,
                      final double[] pd) {
   ...
   detxt= new double[32], detxxt= new double[64], detxtxt= new double[64];
  ...
  //--------------------------------------------------------------------
  private static final double incircleadapt (final double[] pa,
                                             final double[] pb,
                                             final double[] pc,
                                             final double[] pd,
                                             final double permanent) {
    ...
    aybc= new double[8], ayybc= new double[16], adet= new double[32];
    int axbclen, axxbclen, aybclen, ayybclen, alen;
    double[] bxca= new double[ 8],bxxca= new double[16],
    byca= new double[8], byyca= new double[16], bdet= new double[32];
    int bxcalen, bxxcalen, bycalen, byycalen, blen;
    double[] cxab= new double[ 8],cxxab= new double[16],
    cyab= new double[8], cyyab= new double[16], cdet= new double[32];
    ...
    bxtca=new double[8], bytca=new double[8], cxtab=new double[8],
    cytab=new double[8];
    int axtbclen=-1, aytbclen=-1, bxtcalen=-1, bytcalen=-1,
      cxtablen=-1, cytablen=-1;
    double[] axtbct=new double[ 16],
    aytbct=new double[16], bxtcat=new double[16], bytcat=new double[16],
    ...
    if ((bdxtail != 0.0) || (bdytail != 0.0)
      ...
      adxadx1 = (double) (adx * adx); c = (double) (SPLITTER * adx);
      abig = (double) (c - adx); ahi = c - abig; alo = adx - ahi;
      err1 = adxadx1 - (ahi * ahi); err3 = err1 - ((ahi + ahi) * alo);
      adxadx0 = (alo * alo) - err3;
      adyady1 = (double) (ady * ady); c = (double) (SPLITTER * ady);
      abig = (double) (c - ady); ahi = c - abig; alo = ady - ahi;
      err1 = adyady1 - (ahi * ahi); err3 = err1 - ((ahi + ahi) * alo);
      adyady0 = (alo * alo) - err3;
      _i = (double) (adxadx0 + adyady0);
      bvirt = (double) (_i - adxadx0); avirt = _i - bvirt;
      bround = adyady0 - bvirt; around = adxadx0 - avirt;
      aa[0] = around + bround; _j = (double) (adxadx1 + _i);
      bvirt = (double) (_j - adxadx1); avirt = _j - bvirt;
      bround = _i - bvirt; around = adxadx1 - avirt;
      _0 = around + bround; _i = (double) (_0 + adyady1);
      bvirt = (double) (_i - _0); avirt = _i - bvirt;
      bround = adyady1 - bvirt; around = _0 - avirt;
      aa[1] = around + bround; aa3 = (double) (_j + _i);
      bvirt = (double) (aa3 - _j); avirt = aa3 - bvirt;
      bround = _i - bvirt; around = _j - avirt; aa[2] = around + bround;
      aa[3] = aa3;
    }
    if ((cdxtail != 0.0) || (cdytail != 0.0)
      || (adxtail != 0.0) || (adytail != 0.0)) {
      bdxbdx1 = (double) (bdx * bdx); c = (double) (SPLITTER * bdx);
      abig = (double) (c - bdx); ahi = c - abig; alo = bdx - ahi;
      err1 = bdxbdx1 - (ahi * ahi); err3 = err1 - ((ahi + ahi) * alo);
      bdxbdx0 = (alo * alo) - err3;
      bdybdy1 = (double) (bdy * bdy); c = (double) (SPLITTER * bdy);
      abig = (double) (c - bdy); ahi = c - abig; alo = bdy - ahi;
      err1 = bdybdy1 - (ahi * ahi); err3 = err1 - ((ahi + ahi) * alo);
      bdybdy0 = (alo * alo) - err3;
      _i = (double) (bdxbdx0 + bdybdy0);
      bvirt = (double) (_i - bdxbdx0); avirt = _i - bvirt;
      bround = bdybdy0 - bvirt; around = bdxbdx0 - avirt;
      bb[0] = around + bround; _j = (double) (bdxbdx1 + _i);
      bvirt = (double) (_j - bdxbdx1); avirt = _j - bvirt;
      bround = _i - bvirt; around = bdxbdx1 - avirt;
      _0 = around + bround; _i = (double) (_0 + bdybdy1);
      bvirt = (double) (_i - _0); avirt = _i - bvirt;
      bround = bdybdy1 - bvirt; around = _0 - avirt;
      bb[1] = around + bround; bb3 = (double) (_j + _i);
      bvirt = (double) (bb3 - _j); avirt = bb3 - bvirt;
      bround = _i - bvirt; around = _j - avirt; bb[2] = around + bround;
      bb[3] = bb3;
    }
    if ((adxtail != 0.0) || (adytail != 0.0)
      || (bdxtail != 0.0) || (bdytail != 0.0)) {
      cdxcdx1 = (double) (cdx * cdx); c = (double) (SPLITTER * cdx);
      abig = (double) (c - cdx); ahi = c - abig; alo = cdx - ahi;
      err1 = cdxcdx1 - (ahi * ahi); err3 = err1 - ((ahi + ahi) * alo);
      cdxcdx0 = (alo * alo) - err3;
      cdycdy1 = (double) (cdy * cdy); c = (double) (SPLITTER * cdy);
      abig = (double) (c - cdy); ahi = c - abig; alo = cdy - ahi;
      err1 = cdycdy1 - (ahi * ahi); err3 = err1 - ((ahi + ahi) * alo);
      cdycdy0 = (alo * alo) - err3;
      _i = (double) (cdxcdx0 + cdycdy0);
      bvirt = (double) (_i - cdxcdx0); avirt = _i - bvirt;
      bround = cdycdy0 - bvirt; around = cdxcdx0 - avirt;
      cc[0] = around + bround; _j = (double) (cdxcdx1 + _i);
      bvirt = (double) (_j - cdxcdx1); avirt = _j - bvirt;
      bround = _i - bvirt; around = cdxcdx1 - avirt;
      _0 = around + bround; _i = (double) (_0 + cdycdy1);
      bvirt = (double) (_i - _0); avirt = _i - bvirt;
      bround = cdycdy1 - bvirt; around = _0 - avirt;
      cc[1] = around + bround; cc3 = (double) (_j + _i);
      bvirt = (double) (cc3 - _j); avirt = cc3 - bvirt;
    ...
    if ((adxtail != 0.0) || (adytail != 0.0)) {
      if ((bdxtail != 0.0) || (bdytail != 0.0)
        ...
        tj1 = (double) (bdx * cdytail); c = (double) (SPLITTER * bdx);
        abig = (double) (c - bdx); ahi = c - abig; alo = bdx - ahi;
        c = (double) (SPLITTER * cdytail);
        abig = (double) (c - cdytail); bhi = c - abig;
        ...
        err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
        tj0 = (alo * blo) - err3;
        _i = (double) (ti0 + tj0); bvirt = (double) (_i - ti0);
        avirt = _i - bvirt; bround = tj0 - bvirt; around = ti0 - avirt;
        u[0] = around + bround; _j = (double) (ti1 + _i);
        bvirt = (double) (_j - ti1); avirt = _j - bvirt;
        bround = _i - bvirt; around = ti1 - avirt; _0 = around + bround;
        _i = (double) (_0 + tj1); bvirt = (double) (_i - _0);
        avirt = _i - bvirt; bround = tj1 - bvirt; around = _0 - avirt;
        u[1] = around + bround; u3 = (double) (_j + _i);
        bvirt = (double) (u3 - _j); avirt = u3 - bvirt;
        bround = _i - bvirt; around = _j - avirt;
        u[2] = around + bround;
        u[3] = u3;
        negate = -bdy;
        ...
        c = (double) (SPLITTER * cdxtail);
        abig = (double) (c - cdxtail); ahi = c - abig;
        alo = cdxtail - ahi; c = (double) (SPLITTER * negate);
        abig = (double) (c - negate); bhi = c - abig;
        blo = negate - bhi; err1 = ti1 - (ahi * bhi);
        err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
        ti0 = (alo * blo) - err3;
        negate = -bdytail;
        tj1 = (double) (cdx * negate); c = (double) (SPLITTER * cdx);
        abig = (double) (c - cdx); ahi = c - abig; alo = cdx - ahi;
        c = (double) (SPLITTER * negate); abig = (double) (c - negate);
        ...
        _i = (double) (ti0 + tj0); bvirt = (double) (_i - ti0);
        avirt = _i - bvirt; bround = tj0 - bvirt; around = ti0 - avirt;
        v[0] = around + bround; _j = (double) (ti1 + _i);
        bvirt = (double) (_j - ti1); avirt = _j - bvirt;
        bround = _i - bvirt; around = ti1 - avirt; _0 = around + bround;
        _i = (double) (_0 + tj1); bvirt = (double) (_i - _0);
        avirt = _i - bvirt; bround = tj1 - bvirt; around = _0 - avirt;
        v[1] = around + bround; v3 = (double) (_j + _i);
        bvirt = (double) (v3 - _j); avirt = v3 - bvirt;
        bround = _i - bvirt; around = _j - avirt;
        v[2] = around + bround;
        v[3] = v3;
        ...
        c = (double) (SPLITTER * cdxtail);
        abig = (double) (c - cdxtail); ahi = c - abig;
        alo = cdxtail - ahi; c = (double) (SPLITTER * bdytail);
        abig = (double) (c - bdytail); bhi = c - abig;
        blo = bdytail - bhi; err1 = tj1 - (ahi * bhi);
        err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
        tj0 = (alo * blo) - err3;
        _i = (double) (ti0 - tj0); bvirt = (double) (ti0 - _i);
        avirt = _i + bvirt; bround = bvirt - tj0; around = ti0 - avirt;
        bctt[0] = around + bround; _j = (double) (ti1 + _i);
        bvirt = (double) (_j - ti1); avirt = _j - bvirt;
        bround = _i - bvirt; around = ti1 - avirt; _0 = around + bround;
        _i = (double) (_0 - tj1); bvirt = (double) (_0 - _i);
        avirt = _i + bvirt; bround = bvirt - tj1; around = _0 - avirt;
        bctt[1] = around + bround; bctt3 = (double) (_j + _i);
        bvirt = (double) (bctt3 - _j); avirt = bctt3 - bvirt;
        bround = _i - bvirt; around = _j - avirt;
...
// TODO: aytbclen not initialized!!!
    ...
    if ((bdxtail != 0.0) || (bdytail != 0.0)) {
      if ((cdxtail != 0.0) || (cdytail != 0.0)
        ...
        err1 = ti1 - (ahi * bhi); err2 = err1 - (alo * bhi);
        err3 = err2 - (ahi * blo); ti0 = (alo * blo) - err3;
        tj1 = (double) (cdx * adytail); c = (double) (SPLITTER * cdx);
        abig = (double) (c - cdx); ahi = c - abig; alo = cdx - ahi;
        c = (double) (SPLITTER * adytail);
        abig = (double) (c - adytail); bhi = c - abig;
        ...
        c = (double) (SPLITTER * adxtail);
        abig = (double) (c - adxtail); ahi = c - abig;
        alo = adxtail - ahi; c = (double) (SPLITTER * negate);
        abig = (double) (c - negate); bhi = c - abig;
        blo = negate - bhi; err1 = ti1 - (ahi * bhi);
        err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
        ti0 = (alo * blo) - err3;
        negate = -cdytail;
        tj1 = (double) (adx * negate); c = (double) (SPLITTER * adx);
        abig = (double) (c - adx); ahi = c - abig; alo = adx - ahi;
        c = (double) (SPLITTER * negate); abig = (double) (c - negate);
        bhi = c - abig; blo = negate - bhi; err1 = tj1 - (ahi * bhi);
        err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
        ...
        c = (double) (SPLITTER * adxtail);
        abig = (double) (c - adxtail); ahi = c - abig;
        alo = adxtail - ahi; c = (double) (SPLITTER * cdytail);
        abig = (double) (c - cdytail); bhi = c - abig;
        blo = cdytail - bhi; err1 = tj1 - (ahi * bhi);
        err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
        tj0 = (alo * blo) - err3;
        _i = (double) (ti0 - tj0); bvirt = (double) (ti0 - _i);
        avirt = _i + bvirt; bround = bvirt - tj0; around = ti0 - avirt;
        catt[0] = around + bround; _j = (double) (ti1 + _i);
        bvirt = (double) (_j - ti1); avirt = _j - bvirt;
        bround = _i - bvirt; around = ti1 - avirt; _0 = around + bround;
        _i = (double) (_0 - tj1); bvirt = (double) (_0 - _i);
        avirt = _i + bvirt; bround = bvirt - tj1; around = _0 - avirt;
        catt[1] = around + bround; catt3 = (double) (_j + _i);
        bvirt = (double) (catt3 - _j); avirt = catt3 - bvirt;
        bround = _i - bvirt; around = _j - avirt;
...
// TODO: bxtcalen not initialized!!!
    ...
    if ((cdxtail != 0.0) || (cdytail != 0.0)) {
      if ((adxtail != 0.0) || (adytail != 0.0)
        ...
        err1 = ti1 - (ahi * bhi); err2 = err1 - (alo * bhi);
        err3 = err2 - (ahi * blo); ti0 = (alo * blo) - err3;
        tj1 = (double) (adx * bdytail); c = (double) (SPLITTER * adx);
        abig = (double) (c - adx); ahi = c - abig; alo = adx - ahi;
        c = (double) (SPLITTER * bdytail);
        abig = (double) (c - bdytail); bhi = c - abig;
        blo = bdytail - bhi; err1 = tj1 - (ahi * bhi);
        ...
        c = (double) (SPLITTER * bdxtail);
        abig = (double) (c - bdxtail); ahi = c - abig;
        alo = bdxtail - ahi; c = (double) (SPLITTER * negate);
        abig = (double) (c - negate); bhi = c - abig;
        blo = negate - bhi; err1 = ti1 - (ahi * bhi);
        err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
        ti0 = (alo * blo) - err3;
        negate = -adytail;
        tj1 = (double) (bdx * negate); c = (double) (SPLITTER * bdx);
        abig = (double) (c - bdx); ahi = c - abig; alo = bdx - ahi;
        c = (double) (SPLITTER * negate); abig = (double) (c - negate);
        bhi = c - abig; blo = negate - bhi; err1 = tj1 - (ahi * bhi);
        err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
        ...
        c = (double) (SPLITTER * bdxtail);
        abig = (double) (c - bdxtail); ahi = c - abig;
        alo = bdxtail - ahi; c = (double) (SPLITTER * adytail);
        abig = (double) (c - adytail); bhi = c - abig;
        blo = adytail - bhi; err1 = tj1 - (ahi * bhi);
        err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
        tj0 = (alo * blo) - err3;
        _i = (double) (ti0 - tj0); bvirt = (double) (ti0 - _i);
        avirt = _i + bvirt; bround = bvirt - tj0; around = ti0 - avirt;
        abtt[0] = around + bround; _j = (double) (ti1 + _i);
        bvirt = (double) (_j - ti1); avirt = _j - bvirt;
        bround = _i - bvirt; around = ti1 - avirt; _0 = around + bround;
        _i = (double) (_0 - tj1); bvirt = (double) (_0 - _i);
        avirt = _i + bvirt; bround = bvirt - tj1; around = _0 - avirt;
        abtt[1] = around + bround; abtt3 = (double) (_j + _i);
        bvirt = (double) (abtt3 - _j); avirt = abtt3 - bvirt;
        bround = _i - bvirt; around = _j - avirt;
...
// TODO: cytablen not initialized!!!
  ...
  //--------------------------------------------------------------------
  private static final double inspherefast (final double[] pa,
                                            final double[] pb,
                                            final double[] pc,
                                            final double[] pd,
                                            final double[] pe) {
  ...
  private static final double insphereexact (final double[] pa,
    ...
    double[] abc=new double[ 24],bcd=new double[24], cde=new double[24],
    dea=new double[24], eab=new double[24];
    double[] abd=new double[ 24],bce=new double[24], cda=new double[24],
    ...
    cdea=new double[96], deab=new double[96], eabc=new double[96];
    ...
    dxey1 = (double) (pd[0] * pe[1]); c = (double) (SPLITTER * pd[0]);
    abig = (double) (c - pd[0]); ahi = c - abig; alo = pd[0] - ahi;
    c = (double) (SPLITTER * pe[1]); abig = (double) (c - pe[1]);
    bhi = c - abig; blo = pe[1] - bhi; err1 = dxey1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    dxey0 = (alo * blo) - err3;
    exdy1 = (double) (pe[0] * pd[1]); c = (double) (SPLITTER * pe[0]);
    abig = (double) (c - pe[0]); ahi = c - abig; alo = pe[0] - ahi;
    c = (double) (SPLITTER * pd[1]); abig = (double) (c - pd[1]);
    bhi = c - abig; blo = pd[1] - bhi; err1 = exdy1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    exdy0 = (alo * blo) - err3;
    _i = (double) (dxey0 - exdy0); bvirt = (double) (dxey0 - _i);
    avirt = _i + bvirt; bround = bvirt - exdy0; around = dxey0 - avirt;
    de[0] = around + bround; _j = (double) (dxey1 + _i);
    bvirt = (double) (_j - dxey1); avirt = _j - bvirt;
    bround = _i - bvirt; around = dxey1 - avirt; _0 = around + bround;
    _i = (double) (_0 - exdy1); bvirt = (double) (_0 - _i);
    avirt = _i + bvirt; bround = bvirt - exdy1; around = _0 - avirt;
    de[1] = around + bround; de[3] = (double) (_j + _i);
    bvirt = (double) (de[3] - _j); avirt = de[3] - bvirt;
    bround = _i - bvirt; around = _j - avirt; de[2] = around + bround;

    exay1 = (double) (pe[0] * pa[1]); c = (double) (SPLITTER * pe[0]);
    abig = (double) (c - pe[0]); ahi = c - abig; alo = pe[0] - ahi;
    c = (double) (SPLITTER * pa[1]); abig = (double) (c - pa[1]);
    bhi = c - abig; blo = pa[1] - bhi; err1 = exay1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    exay0 = (alo * blo) - err3;
    axey1 = (double) (pa[0] * pe[1]); c = (double) (SPLITTER * pa[0]);
    abig = (double) (c - pa[0]); ahi = c - abig; alo = pa[0] - ahi;
    c = (double) (SPLITTER * pe[1]); abig = (double) (c - pe[1]);
    bhi = c - abig; blo = pe[1] - bhi; err1 = axey1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    axey0 = (alo * blo) - err3;
    _i = (double) (exay0 - axey0); bvirt = (double) (exay0 - _i);
    avirt = _i + bvirt; bround = bvirt - axey0; around = exay0 - avirt;
    ea[0] = around + bround; _j = (double) (exay1 + _i);
    bvirt = (double) (_j - exay1); avirt = _j - bvirt;
    bround = _i - bvirt; around = exay1 - avirt; _0 = around + bround;
    _i = (double) (_0 - axey1); bvirt = (double) (_0 - _i);
    avirt = _i + bvirt; bround = bvirt - axey1; around = _0 - avirt;
    ea[1] = around + bround; ea[3] = (double) (_j + _i);
    bvirt = (double) (ea[3] - _j); avirt = ea[3] - bvirt;
    ...
    cxey1 = (double) (pc[0] * pe[1]); c = (double) (SPLITTER * pc[0]);
    abig = (double) (c - pc[0]); ahi = c - abig; alo = pc[0] - ahi;
    c = (double) (SPLITTER * pe[1]); abig = (double) (c - pe[1]);
    bhi = c - abig; blo = pe[1] - bhi; err1 = cxey1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    cxey0 = (alo * blo) - err3;
    excy1 = (double) (pe[0] * pc[1]); c = (double) (SPLITTER * pe[0]);
    abig = (double) (c - pe[0]); ahi = c - abig; alo = pe[0] - ahi;
    c = (double) (SPLITTER * pc[1]); abig = (double) (c - pc[1]);
    bhi = c - abig; blo = pc[1] - bhi; err1 = excy1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    excy0 = (alo * blo) - err3;
    _i = (double) (cxey0 - excy0); bvirt = (double) (cxey0 - _i);
    avirt = _i + bvirt; bround = bvirt - excy0; around = cxey0 - avirt;
    ce[0] = around + bround; _j = (double) (cxey1 + _i);
    bvirt = (double) (_j - cxey1); avirt = _j - bvirt;
    bround = _i - bvirt; around = cxey1 - avirt; _0 = around + bround;
    _i = (double) (_0 - excy1); bvirt = (double) (_0 - _i);
    avirt = _i + bvirt; bround = bvirt - excy1; around = _0 - avirt;
    ce[1] = around + bround; ce[3] = (double) (_j + _i);
    bvirt = (double) (ce[3] - _j); avirt = ce[3] - bvirt;
    ...
    exby1 = (double) (pe[0] * pb[1]); c = (double) (SPLITTER * pe[0]);
    abig = (double) (c - pe[0]); ahi = c - abig; alo = pe[0] - ahi;
    c = (double) (SPLITTER * pb[1]); abig = (double) (c - pb[1]);
    bhi = c - abig; blo = pb[1] - bhi; err1 = exby1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    exby0 = (alo * blo) - err3;
    bxey1 = (double) (pb[0] * pe[1]); c = (double) (SPLITTER * pb[0]);
    abig = (double) (c - pb[0]); ahi = c - abig; alo = pb[0] - ahi;
    c = (double) (SPLITTER * pe[1]); abig = (double) (c - pe[1]);
    bhi = c - abig; blo = pe[1] - bhi; err1 = bxey1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    bxey0 = (alo * blo) - err3;
    _i = (double) (exby0 - bxey0); bvirt = (double) (exby0 - _i);
    avirt = _i + bvirt; bround = bvirt - bxey0; around = exby0 - avirt;
    eb[0] = around + bround; _j = (double) (exby1 + _i);
    bvirt = (double) (_j - exby1); avirt = _j - bvirt;
    bround = _i - bvirt; around = exby1 - avirt; _0 = around + bround;
    _i = (double) (_0 - bxey1); bvirt = (double) (_0 - _i);
    avirt = _i + bvirt; bround = bvirt - bxey1; around = _0 - avirt;
    eb[1] = around + bround; eb[3] = (double) (_j + _i);
    bvirt = (double) (eb[3] - _j); avirt = eb[3] - bvirt;
    ...
    xylen =
      fast_expansion_sum_zeroelim(xlen, det384x, ylen, det384y, detxy);
    elen =
      fast_expansion_sum_zeroelim(xylen, detxy, zlen, det384z, edet);

    ablen = fast_expansion_sum_zeroelim(alen, adet, blen, bdet, abdet);
    cdlen = fast_expansion_sum_zeroelim(clen, cdet, dlen, ddet, cddet);
    cdelen =
      fast_expansion_sum_zeroelim(cdlen, cddet, elen, edet, cdedet);
    deterlen =
  ...
  //--------------------------------------------------------------------
  private static final double insphereslow (final double[] pa,
                                            final double[] pb,
                                            final double[] pc,
                                            final double[] pd,
                                            final double[] pe) {
    ...
    dxby=new double[8];
    double[] ab=new double[ 16],bc=new double[16], cd=new double[16],
    ...
    bvirt = (double) (_m - _l); avirt = _m - bvirt; bround = _j - bvirt;
    around = _l - avirt; _2 = around + bround;
    _j = (double) (aex * bey); err1 = _j - (a1hi * bhi);
    err2 = err1 - (a1lo * bhi); err3 = err2 - (a1hi * blo);
    _0 = (a1lo * blo) - err3; _n = (double) (_i + _0);
    bvirt = (double) (_n - _i); avirt = _n - bvirt; bround = _0 - bvirt;
    around = _i - avirt; _0 = around + bround; _i = (double) (_1 + _0);
  ...
  ;
    ...
    negate = -aey;
    negatetail = -aeytail;
    c = (double) (SPLITTER * bextail); abig = (double) (c - bextail);
    a0hi = c - abig; a0lo = bextail - a0hi;
    c = (double) (SPLITTER * negatetail);
    abig = (double) (c - negatetail); bhi = c - abig;
    blo = negatetail - bhi; _i = (double) (bextail * negatetail);
    err1 = _i - (a0hi * bhi); err2 = err1 - (a0lo * bhi);
    err3 = err2 - (a0hi * blo); bxay[0] = (a0lo * blo) - err3;
    c = (double) (SPLITTER * bex); abig = (double) (c - bex);
    a1hi = c - abig; a1lo = bex - a1hi;
    _j = (double) (bex * negatetail); err1 = _j - (a1hi * bhi);
    err2 = err1 - (a1lo * bhi); err3 = err2 - (a1hi * blo);
    _0 = (a1lo * blo) - err3; _k = (double) (_i + _0);
    bvirt = (double) (_k - _i); avirt = _k - bvirt; bround = _0 - bvirt;
    around = _i - avirt; _1 = around + bround; _l = (double) (_j + _k);
    bvirt = _l - _j; _2 = _k - bvirt; c = (double) (SPLITTER * negate);
    abig = (double) (c - negate); bhi = c - abig; blo = negate - bhi;
    _i = (double) (bextail * negate); err1 = _i - (a0hi * bhi);
    err2 = err1 - (a0lo * bhi); err3 = err2 - (a0hi * blo);
    _0 = (a0lo * blo) - err3; _k = (double) (_1 + _0);
    bvirt = (double) (_k - _1); avirt = _k - bvirt; bround = _0 - bvirt;
    around = _1 - avirt; bxay[1] = around + bround;
    ...
    bvirt = (double) (_m - _l); avirt = _m - bvirt; bround = _j - bvirt;
    around = _l - avirt; _2 = around + bround;
    _j = (double) (bex * negate); err1 = _j - (a1hi * bhi);
    err2 = err1 - (a1lo * bhi); err3 = err2 - (a1hi * blo);
    _0 = (a1lo * blo) - err3; _n = (double) (_i + _0);
    bvirt = (double) (_n - _i); avirt = _n - bvirt; bround = _0 - bvirt;
    around = _i - avirt; _0 = around + bround; _i = (double) (_1 + _0);
  ...
  ;
    ...
    c = (double) (SPLITTER * bextail); abig = (double) (c - bextail);
    a0hi = c - abig; a0lo = bextail - a0hi;
    c = (double) (SPLITTER * ceytail); abig = (double) (c - ceytail);
    bhi = c - abig; blo = ceytail - bhi;
    _i = (double) (bextail * ceytail); err1 = _i - (a0hi * bhi);
    err2 = err1 - (a0lo * bhi); err3 = err2 - (a0hi * blo);
    bxcy[0] = (a0lo * blo) - err3; c = (double) (SPLITTER * bex);
    abig = (double) (c - bex); a1hi = c - abig; a1lo = bex - a1hi;
    _j = (double) (bex * ceytail); err1 = _j - (a1hi * bhi);
    err2 = err1 - (a1lo * bhi); err3 = err2 - (a1hi * blo);
    _0 = (a1lo * blo) - err3; _k = (double) (_i + _0);
    bvirt = (double) (_k - _i); avirt = _k - bvirt; bround = _0 - bvirt;
    around = _i - avirt; _1 = around + bround; _l = (double) (_j + _k);
    bvirt = _l - _j; _2 = _k - bvirt; c = (double) (SPLITTER * cey);
    abig = (double) (c - cey); bhi = c - abig; blo = cey - bhi;
    _i = (double) (bextail * cey); err1 = _i - (a0hi * bhi);
    err2 = err1 - (a0lo * bhi); err3 = err2 - (a0hi * blo);
    _0 = (a0lo * blo) - err3; _k = (double) (_1 + _0);
    bvirt = (double) (_k - _1); avirt = _k - bvirt; bround = _0 - bvirt;
    around = _1 - avirt; bxcy[1] = around + bround;
    ...
    bvirt = (double) (_m - _l); avirt = _m - bvirt; bround = _j - bvirt;
    around = _l - avirt; _2 = around + bround;
    _j = (double) (bex * cey); err1 = _j - (a1hi * bhi);
    err2 = err1 - (a1lo * bhi); err3 = err2 - (a1hi * blo);
    _0 = (a1lo * blo) - err3; _n = (double) (_i + _0);
    bvirt = (double) (_n - _i); avirt = _n - bvirt; bround = _0 - bvirt;
    around = _i - avirt; _0 = around + bround; _i = (double) (_1 + _0);
  ...
  ;
    ...
    negate = -bey;
    negatetail = -beytail;
    c = (double) (SPLITTER * cextail); abig = (double) (c - cextail);
    a0hi = c - abig; a0lo = cextail - a0hi;
    c = (double) (SPLITTER * negatetail);
    abig = (double) (c - negatetail); bhi = c - abig;
    blo = negatetail - bhi; _i = (double) (cextail * negatetail);
    err1 = _i - (a0hi * bhi); err2 = err1 - (a0lo * bhi);
    err3 = err2 - (a0hi * blo); cxby[0] = (a0lo * blo) - err3;
    c = (double) (SPLITTER * cex); abig = (double) (c - cex);
    a1hi = c - abig; a1lo = cex - a1hi;
    _j = (double) (cex * negatetail); err1 = _j - (a1hi * bhi);
    err2 = err1 - (a1lo * bhi); err3 = err2 - (a1hi * blo);
    _0 = (a1lo * blo) - err3; _k = (double) (_i + _0);
    bvirt = (double) (_k - _i); avirt = _k - bvirt; bround = _0 - bvirt;
    around = _i - avirt; _1 = around + bround; _l = (double) (_j + _k);
    bvirt = _l - _j; _2 = _k - bvirt; c = (double) (SPLITTER * negate);
    abig = (double) (c - negate); bhi = c - abig; blo = negate - bhi;
    _i = (double) (cextail * negate); err1 = _i - (a0hi * bhi);
    err2 = err1 - (a0lo * bhi); err3 = err2 - (a0hi * blo);
    _0 = (a0lo * blo) - err3; _k = (double) (_1 + _0);
    bvirt = (double) (_k - _1); avirt = _k - bvirt; bround = _0 - bvirt;
    around = _1 - avirt; cxby[1] = around + bround;
    ...
    bvirt = (double) (_m - _l); avirt = _m - bvirt; bround = _j - bvirt;
    around = _l - avirt; _2 = around + bround;
    _j = (double) (cex * negate); err1 = _j - (a1hi * bhi);
    err2 = err1 - (a1lo * bhi); err3 = err2 - (a1hi * blo);
    _0 = (a1lo * blo) - err3; _n = (double) (_i + _0);
    bvirt = (double) (_n - _i); avirt = _n - bvirt; bround = _0 - bvirt;
    around = _i - avirt; _0 = around + bround; _i = (double) (_1 + _0);
  ...
  ;
    ...
    c = (double) (SPLITTER * cextail); abig = (double) (c - cextail);
    a0hi = c - abig; a0lo = cextail - a0hi;
    c = (double) (SPLITTER * deytail); abig = (double) (c - deytail);
    bhi = c - abig; blo = deytail - bhi;
    _i = (double) (cextail * deytail); err1 = _i - (a0hi * bhi);
    err2 = err1 - (a0lo * bhi); err3 = err2 - (a0hi * blo);
    cxdy[0] = (a0lo * blo) - err3; c = (double) (SPLITTER * cex);
    abig = (double) (c - cex); a1hi = c - abig; a1lo = cex - a1hi;
    _j = (double) (cex * deytail); err1 = _j - (a1hi * bhi);
    err2 = err1 - (a1lo * bhi); err3 = err2 - (a1hi * blo);
    _0 = (a1lo * blo) - err3; _k = (double) (_i + _0);
    bvirt = (double) (_k - _i); avirt = _k - bvirt; bround = _0 - bvirt;
    around = _i - avirt; _1 = around + bround; _l = (double) (_j + _k);
    bvirt = _l - _j; _2 = _k - bvirt; c = (double) (SPLITTER * dey);
    abig = (double) (c - dey); bhi = c - abig; blo = dey - bhi;
    _i = (double) (cextail * dey); err1 = _i - (a0hi * bhi);
    err2 = err1 - (a0lo * bhi); err3 = err2 - (a0hi * blo);
    _0 = (a0lo * blo) - err3; _k = (double) (_1 + _0);
    bvirt = (double) (_k - _1); avirt = _k - bvirt; bround = _0 - bvirt;
    ...
    bvirt = (double) (_m - _l); avirt = _m - bvirt; bround = _j - bvirt;
    around = _l - avirt; _2 = around + bround;
    _j = (double) (cex * dey); err1 = _j - (a1hi * bhi);
    err2 = err1 - (a1lo * bhi); err3 = err2 - (a1hi * blo);
    _0 = (a1lo * blo) - err3; _n = (double) (_i + _0);
    bvirt = (double) (_n - _i); avirt = _n - bvirt; bround = _0 - bvirt;
    around = _i - avirt; _0 = around + bround; _i = (double) (_1 + _0);
    ...
    _k = (double) (_2 + _i); bvirt = (double) (_k - _2);
    avirt = _k - bvirt; bround = _i - bvirt; around = _2 - avirt;
    cxdy[5] = around + bround; cxdy7 = (double) (_m + _k);
    bvirt = (double) (cxdy7 - _m); avirt = cxdy7 - bvirt;
  ...
  ;
    ...
    negate = -cey;
    negatetail = -ceytail;
    c = (double) (SPLITTER * dextail); abig = (double) (c - dextail);
    a0hi = c - abig; a0lo = dextail - a0hi;
    c = (double) (SPLITTER * negatetail);
    abig = (double) (c - negatetail); bhi = c - abig;
    blo = negatetail - bhi; _i = (double) (dextail * negatetail);
    err1 = _i - (a0hi * bhi); err2 = err1 - (a0lo * bhi);
    err3 = err2 - (a0hi * blo); dxcy[0] = (a0lo * blo) - err3;
    c = (double) (SPLITTER * dex); abig = (double) (c - dex);
    a1hi = c - abig; a1lo = dex - a1hi;
    _j = (double) (dex * negatetail); err1 = _j - (a1hi * bhi);
    err2 = err1 - (a1lo * bhi); err3 = err2 - (a1hi * blo);
    _0 = (a1lo * blo) - err3; _k = (double) (_i + _0);
    bvirt = (double) (_k - _i); avirt = _k - bvirt; bround = _0 - bvirt;
    around = _i - avirt; _1 = around + bround; _l = (double) (_j + _k);
    bvirt = _l - _j; _2 = _k - bvirt; c = (double) (SPLITTER * negate);
    abig = (double) (c - negate); bhi = c - abig; blo = negate - bhi;
    _i = (double) (dextail * negate); err1 = _i - (a0hi * bhi);
    err2 = err1 - (a0lo * bhi); err3 = err2 - (a0hi * blo);
    _0 = (a0lo * blo) - err3; _k = (double) (_1 + _0);
    bvirt = (double) (_k - _1); avirt = _k - bvirt; bround = _0 - bvirt;
    ...
    bvirt = (double) (_m - _l); avirt = _m - bvirt; bround = _j - bvirt;
    around = _l - avirt; _2 = around + bround;
    _j = (double) (dex * negate); err1 = _j - (a1hi * bhi);
    err2 = err1 - (a1lo * bhi); err3 = err2 - (a1hi * blo);
    _0 = (a1lo * blo) - err3; _n = (double) (_i + _0);
    bvirt = (double) (_n - _i); avirt = _n - bvirt; bround = _0 - bvirt;
    around = _i - avirt; _0 = around + bround; _i = (double) (_1 + _0);
    ...
    _k = (double) (_2 + _i); bvirt = (double) (_k - _2);
    avirt = _k - bvirt; bround = _i - bvirt; around = _2 - avirt;
    dxcy[5] = around + bround; dxcy7 = (double) (_m + _k);
    bvirt = (double) (dxcy7 - _m); avirt = dxcy7 - bvirt;
  ...
  ;
    ...
    c = (double) (SPLITTER * dextail); abig = (double) (c - dextail);
    a0hi = c - abig; a0lo = dextail - a0hi;
    c = (double) (SPLITTER * aeytail); abig = (double) (c - aeytail);
    bhi = c - abig; blo = aeytail - bhi;
    _i = (double) (dextail * aeytail); err1 = _i - (a0hi * bhi);
    err2 = err1 - (a0lo * bhi); err3 = err2 - (a0hi * blo);
    dxay[0] = (a0lo * blo) - err3; c = (double) (SPLITTER * dex);
    abig = (double) (c - dex); a1hi = c - abig; a1lo = dex - a1hi;
    _j = (double) (dex * aeytail); err1 = _j - (a1hi * bhi);
    err2 = err1 - (a1lo * bhi); err3 = err2 - (a1hi * blo);
    _0 = (a1lo * blo) - err3; _k = (double) (_i + _0);
    bvirt = (double) (_k - _i); avirt = _k - bvirt; bround = _0 - bvirt;
    around = _i - avirt; _1 = around + bround; _l = (double) (_j + _k);
    bvirt = _l - _j; _2 = _k - bvirt; c = (double) (SPLITTER * aey);
    abig = (double) (c - aey); bhi = c - abig; blo = aey - bhi;
    _i = (double) (dextail * aey); err1 = _i - (a0hi * bhi);
    err2 = err1 - (a0lo * bhi); err3 = err2 - (a0hi * blo);
    _0 = (a0lo * blo) - err3; _k = (double) (_1 + _0);
    bvirt = (double) (_k - _1); avirt = _k - bvirt; bround = _0 - bvirt;
    ...
    bvirt = (double) (_m - _l); avirt = _m - bvirt; bround = _j - bvirt;
    around = _l - avirt; _2 = around + bround;
    _j = (double) (dex * aey); err1 = _j - (a1hi * bhi);
    err2 = err1 - (a1lo * bhi); err3 = err2 - (a1hi * blo);
    _0 = (a1lo * blo) - err3; _n = (double) (_i + _0);
    bvirt = (double) (_n - _i); avirt = _n - bvirt; bround = _0 - bvirt;
    around = _i - avirt; _0 = around + bround; _i = (double) (_1 + _0);
    ...
    _k = (double) (_2 + _i); bvirt = (double) (_k - _2);
    avirt = _k - bvirt; bround = _i - bvirt; around = _2 - avirt;
    dxay[5] = around + bround; dxay7 = (double) (_m + _k);
    bvirt = (double) (dxay7 - _m); avirt = dxay7 - bvirt;
  ...
  ;
    ...
    c = (double) (SPLITTER * negatetail);
    abig = (double) (c - negatetail); bhi = c - abig;
    blo = negatetail - bhi; _i = (double) (aextail * negatetail);
    err1 = _i - (a0hi * bhi); err2 = err1 - (a0lo * bhi);
    err3 = err2 - (a0hi * blo); axdy[0] = (a0lo * blo) - err3;
    c = (double) (SPLITTER * aex); abig = (double) (c - aex);
    a1hi = c - abig; a1lo = aex - a1hi;
    _j = (double) (aex * negatetail); err1 = _j - (a1hi * bhi);
    err2 = err1 - (a1lo * bhi); err3 = err2 - (a1hi * blo);
    _0 = (a1lo * blo) - err3; _k = (double) (_i + _0);
    bvirt = (double) (_k - _i); avirt = _k - bvirt; bround = _0 - bvirt;
    around = _i - avirt; _1 = around + bround; _l = (double) (_j + _k);
    bvirt = _l - _j; _2 = _k - bvirt; c = (double) (SPLITTER * negate);
    abig = (double) (c - negate); bhi = c - abig; blo = negate - bhi;
    _i = (double) (aextail * negate); err1 = _i - (a0hi * bhi);
    err2 = err1 - (a0lo * bhi); err3 = err2 - (a0hi * blo);
    _0 = (a0lo * blo) - err3; _k = (double) (_1 + _0);
    bvirt = (double) (_k - _1); avirt = _k - bvirt; bround = _0 - bvirt;
    ...
    bvirt = (double) (_m - _l); avirt = _m - bvirt; bround = _j - bvirt;
    around = _l - avirt; _2 = around + bround;
    _j = (double) (aex * negate); err1 = _j - (a1hi * bhi);
    err2 = err1 - (a1lo * bhi); err3 = err2 - (a1hi * blo);
    _0 = (a1lo * blo) - err3; _n = (double) (_i + _0);
    bvirt = (double) (_n - _i); avirt = _n - bvirt; bround = _0 - bvirt;
    around = _i - avirt; _0 = around + bround; _i = (double) (_1 + _0);
    ...
    _k = (double) (_2 + _i); bvirt = (double) (_k - _2);
    avirt = _k - bvirt; bround = _i - bvirt; around = _2 - avirt;
    axdy[5] = around + bround; axdy7 = (double) (_m + _k);
    bvirt = (double) (axdy7 - _m); avirt = axdy7 - bvirt;
  ...
  ;
    ...
    c = (double) (SPLITTER * ceytail); abig = (double) (c - ceytail);
    bhi = c - abig; blo = ceytail - bhi;
    _i = (double) (aextail * ceytail); err1 = _i - (a0hi * bhi);
    err2 = err1 - (a0lo * bhi); err3 = err2 - (a0hi * blo);
    axcy[0] = (a0lo * blo) - err3; c = (double) (SPLITTER * aex);
    abig = (double) (c - aex); a1hi = c - abig; a1lo = aex - a1hi;
    _j = (double) (aex * ceytail); err1 = _j - (a1hi * bhi);
    err2 = err1 - (a1lo * bhi); err3 = err2 - (a1hi * blo);
    _0 = (a1lo * blo) - err3; _k = (double) (_i + _0);
    bvirt = (double) (_k - _i); avirt = _k - bvirt; bround = _0 - bvirt;
    around = _i - avirt; _1 = around + bround; _l = (double) (_j + _k);
    bvirt = _l - _j; _2 = _k - bvirt; c = (double) (SPLITTER * cey);
    abig = (double) (c - cey); bhi = c - abig; blo = cey - bhi;
    _i = (double) (aextail * cey); err1 = _i - (a0hi * bhi);
    err2 = err1 - (a0lo * bhi); err3 = err2 - (a0hi * blo);
    _0 = (a0lo * blo) - err3; _k = (double) (_1 + _0);
    bvirt = (double) (_k - _1); avirt = _k - bvirt; bround = _0 - bvirt;
    around = _1 - avirt; axcy[1] = around + bround;
    ...
    bvirt = (double) (_m - _l); avirt = _m - bvirt; bround = _j - bvirt;
    around = _l - avirt; _2 = around + bround;
    _j = (double) (aex * cey); err1 = _j - (a1hi * bhi);
    err2 = err1 - (a1lo * bhi); err3 = err2 - (a1hi * blo);
    _0 = (a1lo * blo) - err3; _n = (double) (_i + _0);
    bvirt = (double) (_n - _i); avirt = _n - bvirt; bround = _0 - bvirt;
    around = _i - avirt; _0 = around + bround; _i = (double) (_1 + _0);
  ...
  ;
    ...
    c = (double) (SPLITTER * deytail); abig = (double) (c - deytail);
    bhi = c - abig; blo = deytail - bhi;
    _i = (double) (bextail * deytail); err1 = _i - (a0hi * bhi);
    err2 = err1 - (a0lo * bhi); err3 = err2 - (a0hi * blo);
    bxdy[0] = (a0lo * blo) - err3; c = (double) (SPLITTER * bex);
    abig = (double) (c - bex); a1hi = c - abig; a1lo = bex - a1hi;
    _j = (double) (bex * deytail); err1 = _j - (a1hi * bhi);
    err2 = err1 - (a1lo * bhi); err3 = err2 - (a1hi * blo);
    _0 = (a1lo * blo) - err3; _k = (double) (_i + _0);
    bvirt = (double) (_k - _i); avirt = _k - bvirt; bround = _0 - bvirt;
    around = _i - avirt; _1 = around + bround; _l = (double) (_j + _k);
    bvirt = _l - _j; _2 = _k - bvirt; c = (double) (SPLITTER * dey);
    abig = (double) (c - dey); bhi = c - abig; blo = dey - bhi;
    _i = (double) (bextail * dey); err1 = _i - (a0hi * bhi);
    err2 = err1 - (a0lo * bhi); err3 = err2 - (a0hi * blo);
    _0 = (a0lo * blo) - err3; _k = (double) (_1 + _0);
    bvirt = (double) (_k - _1); avirt = _k - bvirt; bround = _0 - bvirt;
    ...
    bvirt = (double) (_m - _l); avirt = _m - bvirt; bround = _j - bvirt;
    around = _l - avirt; _2 = around + bround;
    _j = (double) (bex * dey); err1 = _j - (a1hi * bhi);
    err2 = err1 - (a1lo * bhi); err3 = err2 - (a1hi * blo);
    _0 = (a1lo * blo) - err3; _n = (double) (_i + _0);
    bvirt = (double) (_n - _i); avirt = _n - bvirt; bround = _0 - bvirt;
    around = _i - avirt; _0 = around + bround; _i = (double) (_1 + _0);
    ...
    _k = (double) (_2 + _i); bvirt = (double) (_k - _2);
    avirt = _k - bvirt; bround = _i - bvirt; around = _2 - avirt;
    bxdy[5] = around + bround; bxdy7 = (double) (_m + _k);
    bvirt = (double) (bxdy7 - _m); avirt = bxdy7 - bvirt;
  ...
  ;
    ...
    _k = (double) (_2 + _i); bvirt = (double) (_k - _2);
    avirt = _k - bvirt; bround = _i - bvirt; around = _2 - avirt;
    dxby[5] = around + bround; dxby7 = (double) (_m + _k);
    bvirt = (double) (dxby7 - _m); avirt = dxby7 - bvirt;
  ...
  private static final double insphereadapt (final double[] pa,
                                             final double[] pb,
                                             final double[] pc,
                                             final double[] pd,
                                             final double[] pe,
    ...
    aexbey1 = (double) (aex * bey); c = (double) (SPLITTER * aex);
    abig = (double) (c - aex); ahi = c - abig; alo = aex - ahi;
    c = (double) (SPLITTER * bey); abig = (double) (c - bey);
    bhi = c - abig; blo = bey - bhi; err1 = aexbey1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    aexbey0 = (alo * blo) - err3;
    bexaey1 = (double) (bex * aey); c = (double) (SPLITTER * bex);
    abig = (double) (c - bex); ahi = c - abig; alo = bex - ahi;
    c = (double) (SPLITTER * aey); abig = (double) (c - aey);
    bhi = c - abig; blo = aey - bhi; err1 = bexaey1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    bexaey0 = (alo * blo) - err3;
    _i = (double) (aexbey0 - bexaey0); bvirt = (double) (aexbey0 - _i);
    avirt = _i + bvirt; bround = bvirt - bexaey0;
    around = aexbey0 - avirt; ab[0] = around + bround;
    _j = (double) (aexbey1 + _i); bvirt = (double) (_j - aexbey1);
    avirt = _j - bvirt; bround = _i - bvirt; around = aexbey1 - avirt;
    _0 = around + bround; _i = (double) (_0 - bexaey1);
    bvirt = (double) (_0 - _i); avirt = _i + bvirt;
    ...
    bexcey1 = (double) (bex * cey); c = (double) (SPLITTER * bex);
    abig = (double) (c - bex); ahi = c - abig; alo = bex - ahi;
    c = (double) (SPLITTER * cey); abig = (double) (c - cey);
    bhi = c - abig; blo = cey - bhi; err1 = bexcey1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    bexcey0 = (alo * blo) - err3;
    cexbey1 = (double) (cex * bey); c = (double) (SPLITTER * cex);
    abig = (double) (c - cex); ahi = c - abig; alo = cex - ahi;
    c = (double) (SPLITTER * bey); abig = (double) (c - bey);
    bhi = c - abig; blo = bey - bhi; err1 = cexbey1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    cexbey0 = (alo * blo) - err3;
    _i = (double) (bexcey0 - cexbey0); bvirt = (double) (bexcey0 - _i);
    avirt = _i + bvirt; bround = bvirt - cexbey0;
    around = bexcey0 - avirt; bc[0] = around + bround;
    _j = (double) (bexcey1 + _i); bvirt = (double) (_j - bexcey1);
    avirt = _j - bvirt; bround = _i - bvirt; around = bexcey1 - avirt;
    _0 = around + bround; _i = (double) (_0 - cexbey1);
    bvirt = (double) (_0 - _i); avirt = _i + bvirt;
    ...
    cexdey1 = (double) (cex * dey); c = (double) (SPLITTER * cex);
    abig = (double) (c - cex); ahi = c - abig; alo = cex - ahi;
    c = (double) (SPLITTER * dey); abig = (double) (c - dey);
    bhi = c - abig; blo = dey - bhi; err1 = cexdey1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    cexdey0 = (alo * blo) - err3;
    dexcey1 = (double) (dex * cey); c = (double) (SPLITTER * dex);
    abig = (double) (c - dex); ahi = c - abig; alo = dex - ahi;
    c = (double) (SPLITTER * cey); abig = (double) (c - cey);
    bhi = c - abig; blo = cey - bhi; err1 = dexcey1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    dexcey0 = (alo * blo) - err3;
    _i = (double) (cexdey0 - dexcey0); bvirt = (double) (cexdey0 - _i);
    avirt = _i + bvirt; bround = bvirt - dexcey0;
    around = cexdey0 - avirt; cd[0] = around + bround;
    _j = (double) (cexdey1 + _i); bvirt = (double) (_j - cexdey1);
    avirt = _j - bvirt; bround = _i - bvirt; around = cexdey1 - avirt;
    _0 = around + bround; _i = (double) (_0 - dexcey1);
    bvirt = (double) (_0 - _i); avirt = _i + bvirt;
    bround = bvirt - dexcey1; around = _0 - avirt;
    cd[1] = around + bround; cd3 = (double) (_j + _i);
    bvirt = (double) (cd3 - _j); avirt = cd3 - bvirt;
    bround = _i - bvirt; around = _j - avirt; cd[2] = around + bround;
    cd[3] = cd3;

    dexaey1 = (double) (dex * aey); c = (double) (SPLITTER * dex);
    abig = (double) (c - dex); ahi = c - abig; alo = dex - ahi;
    c = (double) (SPLITTER * aey); abig = (double) (c - aey);
    bhi = c - abig; blo = aey - bhi; err1 = dexaey1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    dexaey0 = (alo * blo) - err3;
    aexdey1 = (double) (aex * dey); c = (double) (SPLITTER * aex);
    abig = (double) (c - aex); ahi = c - abig; alo = aex - ahi;
    c = (double) (SPLITTER * dey); abig = (double) (c - dey);
    bhi = c - abig; blo = dey - bhi; err1 = aexdey1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    aexdey0 = (alo * blo) - err3;
    _i = (double) (dexaey0 - aexdey0); bvirt = (double) (dexaey0 - _i);
    avirt = _i + bvirt; bround = bvirt - aexdey0;
    around = dexaey0 - avirt; da[0] = around + bround;
    _j = (double) (dexaey1 + _i); bvirt = (double) (_j - dexaey1);
    avirt = _j - bvirt; bround = _i - bvirt; around = dexaey1 - avirt;
    _0 = around + bround; _i = (double) (_0 - aexdey1);
    bvirt = (double) (_0 - _i); avirt = _i + bvirt;
    bround = bvirt - aexdey1; around = _0 - avirt;
    da[1] = around + bround; da3 = (double) (_j + _i);
    bvirt = (double) (da3 - _j); avirt = da3 - bvirt;
    bround = _i - bvirt; around = _j - avirt; da[2] = around + bround;
    da[3] = da3;

    aexcey1 = (double) (aex * cey); c = (double) (SPLITTER * aex);
    abig = (double) (c - aex); ahi = c - abig; alo = aex - ahi;
    c = (double) (SPLITTER * cey); abig = (double) (c - cey);
    bhi = c - abig; blo = cey - bhi; err1 = aexcey1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    aexcey0 = (alo * blo) - err3;
    cexaey1 = (double) (cex * aey); c = (double) (SPLITTER * cex);
    abig = (double) (c - cex); ahi = c - abig; alo = cex - ahi;
    c = (double) (SPLITTER * aey); abig = (double) (c - aey);
    bhi = c - abig; blo = aey - bhi; err1 = cexaey1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    cexaey0 = (alo * blo) - err3;
    _i = (double) (aexcey0 - cexaey0); bvirt = (double) (aexcey0 - _i);
    avirt = _i + bvirt; bround = bvirt - cexaey0;
    around = aexcey0 - avirt; ac[0] = around + bround;
    _j = (double) (aexcey1 + _i); bvirt = (double) (_j - aexcey1);
    avirt = _j - bvirt; bround = _i - bvirt; around = aexcey1 - avirt;
    _0 = around + bround; _i = (double) (_0 - cexaey1);
    bvirt = (double) (_0 - _i); avirt = _i + bvirt;
    bround = bvirt - cexaey1; around = _0 - avirt;
    ac[1] = around + bround; ac3 = (double) (_j + _i);
    bvirt = (double) (ac3 - _j); avirt = ac3 - bvirt;
    bround = _i - bvirt; around = _j - avirt; ac[2] = around + bround;
    ac[3] = ac3;

    bexdey1 = (double) (bex * dey); c = (double) (SPLITTER * bex);
    abig = (double) (c - bex); ahi = c - abig; alo = bex - ahi;
    c = (double) (SPLITTER * dey); abig = (double) (c - dey);
    bhi = c - abig; blo = dey - bhi; err1 = bexdey1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    bexdey0 = (alo * blo) - err3;
    dexbey1 = (double) (dex * bey); c = (double) (SPLITTER * dex);
    abig = (double) (c - dex); ahi = c - abig; alo = dex - ahi;
    c = (double) (SPLITTER * bey); abig = (double) (c - bey);
    bhi = c - abig; blo = bey - bhi; err1 = dexbey1 - (ahi * bhi);
    err2 = err1 - (alo * bhi); err3 = err2 - (ahi * blo);
    dexbey0 = (alo * blo) - err3;
    _i = (double) (bexdey0 - dexbey0); bvirt = (double) (bexdey0 - _i);
    avirt = _i + bvirt; bround = bvirt - dexbey0;
    around = bexdey0 - avirt; bd[0] = around + bround;
    _j = (double) (bexdey1 + _i); bvirt = (double) (_j - bexdey1);
    avirt = _j - bvirt; bround = _i - bvirt; around = bexdey1 - avirt;
    _0 = around + bround; _i = (double) (_0 - dexbey1);
    bvirt = (double) (_0 - _i); avirt = _i + bvirt;
    bround = bvirt - dexbey1; around = _0 - avirt;
    bd[1] = around + bround; bd3 = (double) (_j + _i);
    bvirt = (double) (bd3 - _j); avirt = bd3 - bvirt;
    bround = _i - bvirt; around = _j - avirt; bd[2] = around + bround;
    bd[3] = bd3;
    ...
    bvirt = (double) (pa[0] - aex); avirt = aex + bvirt;
    bround = bvirt - pe[0]; around = pa[0] - avirt;
    aextail = around + bround;
    bvirt = (double) (pa[1] - aey); avirt = aey + bvirt;
    bround = bvirt - pe[1]; around = pa[1] - avirt;
    aeytail = around + bround;
    bvirt = (double) (pa[2] - aez); avirt = aez + bvirt;
    bround = bvirt - pe[2]; around = pa[2] - avirt;
    aeztail = around + bround;
    bvirt = (double) (pb[0] - bex); avirt = bex + bvirt;
    bround = bvirt - pe[0]; around = pb[0] - avirt;
    bextail = around + bround;
    bvirt = (double) (pb[1] - bey); avirt = bey + bvirt;
    bround = bvirt - pe[1]; around = pb[1] - avirt;
    beytail = around + bround;
    bvirt = (double) (pb[2] - bez); avirt = bez + bvirt;
    bround = bvirt - pe[2]; around = pb[2] - avirt;
    beztail = around + bround;
    bvirt = (double) (pc[0] - cex); avirt = cex + bvirt;
    bround = bvirt - pe[0]; around = pc[0] - avirt;
    cextail = around + bround;
    bvirt = (double) (pc[1] - cey); avirt = cey + bvirt;
    bround = bvirt - pe[1]; around = pc[1] - avirt;
    ceytail = around + bround;
    bvirt = (double) (pc[2] - cez); avirt = cez + bvirt;
    bround = bvirt - pe[2]; around = pc[2] - avirt;
    ceztail = around + bround;
    bvirt = (double) (pd[0] - dex); avirt = dex + bvirt;
    bround = bvirt - pe[0]; around = pd[0] - avirt;
    dextail = around + bround;
    bvirt = (double) (pd[1] - dey); avirt = dey + bvirt;
    bround = bvirt - pe[1]; around = pd[1] - avirt;
    deytail = around + bround;
    bvirt = (double) (pd[2] - dez); avirt = dez + bvirt;
